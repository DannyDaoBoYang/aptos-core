module BasicCoin::ProphecyBenchmark3Levels3Fields {
    ...
    fun select_n2(n: &mut Node3, idx: u64): &mut Node2 {
        if (idx == 0) { &mut n.v0 } 
        else if (idx == 1) { &mut n.v1 }
        else if (idx == 2) { &mut n.v2 }
        else if (idx == 3) { &mut n.v3 }
        else if (idx == 4) { &mut n.v4 }
        else if (idx == 5) { &mut n.v5 }
        else if (idx == 6) { &mut n.v6 }
        else { &mut n.v7 }
    }
    spec select_n2 { 
        pragma opaque = false; 
    ...
    // Step 3: Child (Node1) -> Leaf (u64) - 8 fields
    ...
    public fun benchmark_from_scratch(
        ...
        // Use helper functions to avoid complex borrow chains
        let n2_ref = select_n2(&mut root, idx3);
    ...
    spec benchmark_from_scratch {
        ...
        ensures (c3==0 && c2==0 && c1==0) 
            ==> result.v0.v0.v0 == 1;
        ensures (c3==0 && c2==1 && c1==0) 
            ==> result.v0.v1.v0 == 1;
        ensures (c3%8!=0 || c2%8!=0 || c1%8!=0) 
            ==> result.v0.v0.v0 == 0;
        // 2. Any deviation implies root.v0.v0.v0 was NOT touched
        ensures result.v0.v0.v0 == 0 || result.v0.v0.v0 == 1;
        ensures result.v0.v0.v0 + result.v0.v0.v1 +
        result.v0.v0.v2 + result.v0.v0.v3
        + result.v0.v0.v4
        + result.v1.v0.v5
        + result.v0.v2.v6
        + result.v0.v3.v7 <= 1;
