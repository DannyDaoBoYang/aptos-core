...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 30) (let ((anon4_Else_correct  (=> (and (not $abort_flag@4) (= $t8 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t0))))) (and (=> (= (ControlFlow 0 4) (- 0 6)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0))) (and (=> (= (ControlFlow 0 4) (- 0 5)) (not (> (+ $t3 _$t1) 18446744073709551615))) (=> (not (> (+ $t3 _$t1) 18446744073709551615)) (=> (= (ControlFlow 0 4) (- 0 3)) (= $t8 (+ $t3 _$t1))))))))))
(let ((anon4_Then_correct  (=> $abort_flag@4 (=> (and (= $abort_code@4 $abort_code@4) (= (ControlFlow 0 2) (- 0 1))) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (> (+ $t3 _$t1) 18446744073709551615))))))
...
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon12_Else_correct|  (=> (not $abort_flag@2) (=> (and (and (= call2formal@v@0 (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_60131| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|))) (= (|v#$Mutation_60154| call3formal@result@0@@0) (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_60131| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|)))) (and (= |inline$$bc_BasicCoin_deposit'#0'$0$$t9@2| ($Mutation_60131 (|l#$Mutation_60131| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|) (|p#$Mutation_60131| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|) (|$bc_BasicCoin_Balance'#0'| (|v_final#$Mutation_60154| call3formal@result@0@@0)) (|v_final#$Mutation_60131| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|))) (= (|v#$Mutation_60131| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@2|) (|v_final#$Mutation_60131| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@2|)))) (=> (and (and (and (= call2formal@v@0@@0 (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_60154| call3formal@result@0@@0))) (= (|v#$Mutation_21031| call3formal@result@0) (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_60154| call3formal@result@0@@0)))) (and (= |inline$$bc_BasicCoin_deposit'#0'$0$$t10@1| ($Mutation_60154 (|l#$Mutation_60154| call3formal@result@0@@0) (|p#$Mutation_60154| call3formal@result@0@@0) (|$bc_BasicCoin_Coin'#0'| (|v_final#$Mutation_21031| call3formal@result@0)) (|v_final#$Mutation_60154| call3formal@result@0@@0))) (= (|v#$Mutation_60154| |inline$$bc_BasicCoin_deposit'#0'$0$$t10@1|) (|v_final#$Mutation_60154| |inline$$bc_BasicCoin_deposit'#0'$0$$t10@1|)))) (and (and (= |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1| (|$value#$bc_BasicCoin_Coin'#0'| $t4@0)) (= |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1| |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1|)) (and (= |inline$$bc_BasicCoin_deposit'#0'$0$$temp_0'u64'@1| (|v#$Mutation_21031| call3formal@result@0)) (= |inline$$bc_BasicCoin_deposit'#0'$0$$temp_0'u64'@1| |inline$$bc_BasicCoin_deposit'#0'$0$$temp_0'u64'@1|)))) (and (=> (= (ControlFlow 0 15) 14) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 15) 12) inline$$AddU64$0$anon3_Else_correct)))))))
...
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (= (ControlFlow 0 24) 23)) |inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then$1_correct|)))
...
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon0_correct|  (=> (= |inline$$bc_BasicCoin_deposit'#0'$0$$t5@0| (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)))) (=> (and (and (= |inline$$bc_BasicCoin_deposit'#0'$0$$t6@0| (|$value#$bc_BasicCoin_Coin'#0'| $t4@0)) (= _$t0 _$t0)) (and (= $t4@0 $t4@0) (= (ControlFlow 0 26) 25))) |inline$$bc_BasicCoin_balance_of'#0'$0$anon0_correct|))))
...
))) (=> (and (and (and (= $t3 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)))) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= _$t2 _$t2))) (and (and (= $t4@0 (|$bc_BasicCoin_Coin'#0'| _$t1)) (= $t5 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0))))) (and (= $t6 (|$value#$bc_BasicCoin_Coin'#0'| $t4@0)) (= (ControlFlow 0 27) 26)))) |inline$$bc_BasicCoin_deposit'#0'$0$anon0_correct|)))))
