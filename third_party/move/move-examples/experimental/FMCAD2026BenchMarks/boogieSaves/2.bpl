...
procedure {:timeLimit 40} $bc_ProphecyBenchmark3Levels2Fields_benchmark_from_scratch$verify(_$t0: int, _$t1: int, _$t2: int) returns ($ret0: $bc_ProphecyBenchmark3Levels2Fields_Node3)
{
    ...
    var $t17: int;
    var $t18: int;
    var $t19: $bc_ProphecyBenchmark3Levels2Fields_Node3;
    var $t0: int;
    var $t1: int;
    var $t2: int;
    ...
    // $t3 := ProphecyBenchmark3Levels2Fields::new_node3() on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:85:20+11
    ...
    // $t7 := %($t0, $t6) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:87:20+6
    call $t7 := $Mod($t0, $t6);
    if ($abort_flag) {
    ...
    // $t9 := %($t1, $t8) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:88:20+6
    call $t9 := $Mod($t1, $t8);
    if ($abort_flag) {
    ...
    // $t11 := %($t2, $t10) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:89:20+6
    call $t11 := $Mod($t2, $t10);
    if ($abort_flag) {
    ...
    // $t13 := ProphecyBenchmark3Levels2Fields::select_n2($t12, $t7) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:94:22+23
    ...
    // fulfilled($t12) at .\sources\ConditionalBorrowChain.move:94:22+23
    assume $Fulfilled($t12, $cur_index);

    // $t14 := ProphecyBenchmark3Levels2Fields::select_n1($t13, $t9) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:95:22+23
    ...
    // fulfilled($t13) at .\sources\ConditionalBorrowChain.move:95:22+23
    assume $Fulfilled($t13, $cur_index);

    // $t15 := ProphecyBenchmark3Levels2Fields::select_leaf($t14, $t11) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:96:24+25
    ...
    // fulfilled($t14) at .\sources\ConditionalBorrowChain.move:96:24+25
    ...
    // $t18 := +($t16, $t17) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:97:21+13
...
L1:
    ...
    // return $t19 at .\sources\ConditionalBorrowChain.move:124:9+29
    $ret0 := $t19;
    return;

    // label L2 at .\sources\ConditionalBorrowChain.move:100:5+1
    assume {:print "$at(3,3022,3023)"} true;
L2:
...
L1:
    ...
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels2Fields_Node1'_v0($Dereference($t0), $DereferenceProphecy($t4)));
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:71:9+46
...
L0:
    ...
    call $t6 := $ChildMutationAlt($t0, 1, $Dereference($t0)->$v1);
    assume $Dereference($t6) == $Dereference($t0)->$v1;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels2Fields_Node1'_v1($Dereference($t0), $DereferenceProphecy($t6)));
...
L1:
    ...
    call $t4 := $ChildMutationAlt($t0, 0, $Dereference($t0)->$v0);
    assume $Dereference($t4) == $Dereference($t0)->$v0;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels2Fields_Node2'_v0($Dereference($t0), $DereferenceProphecy($t4)));
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:62:9+46
    assume $Fulfilled($t0, $cur_index);
...
L0:
    ...
    call $t6 := $ChildMutationAlt($t0, 1, $Dereference($t0)->$v1);
    assume $Dereference($t6) == $Dereference($t0)->$v1;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels2Fields_Node2'_v1($Dereference($t0), $DereferenceProphecy($t6)));
...
L1:
    ...
    call $t4 := $ChildMutationAlt($t0, 0, $Dereference($t0)->$v0);
    assume $Dereference($t4) == $Dereference($t0)->$v0;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels2Fields_Node3'_v0($Dereference($t0), $DereferenceProphecy($t4)));
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:53:9+46
    assume $Fulfilled($t0, $cur_index);
...
L0:
    ...
    call $t6 := $ChildMutationAlt($t0, 1, $Dereference($t0)->$v1);
    assume $Dereference($t6) == $Dereference($t0)->$v1;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels2Fields_Node3'_v1($Dereference($t0), $DereferenceProphecy($t6)));
