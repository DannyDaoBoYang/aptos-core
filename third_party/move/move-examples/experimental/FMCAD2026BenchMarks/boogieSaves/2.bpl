...
function $Arbitrary_value_of'$bc_ProphecyBenchmark3Levels2Fields_Node1'(): $bc_ProphecyBenchmark3Levels2Fields_Node1;



function $Arbitrary_value_of'$bc_ProphecyBenchmark3Levels2Fields_Node2'(): $bc_ProphecyBenchmark3Levels2Fields_Node2;



function $Arbitrary_value_of'$bc_ProphecyBenchmark3Levels2Fields_Node3'(): $bc_ProphecyBenchmark3Levels2Fields_Node3;
...
// struct ProphecyBenchmark3Levels2Fields::Node1 at .\sources\ConditionalBorrowChain.move:8:5+131
datatype $bc_ProphecyBenchmark3Levels2Fields_Node1 {
    $bc_ProphecyBenchmark3Levels2Fields_Node1($v0: int, $v1: int, $v2: int, $v3: int, $v4: int, $v5: int, $v6: int, $v7: int)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node1'_v0(s: $bc_ProphecyBenchmark3Levels2Fields_Node1, x: int): $bc_ProphecyBenchmark3Levels2Fields_Node1 {
    $bc_ProphecyBenchmark3Levels2Fields_Node1(x, s->$v1, s->$v2, s->$v3, s->$v4, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node1'_v1(s: $bc_ProphecyBenchmark3Levels2Fields_Node1, x: int): $bc_ProphecyBenchmark3Levels2Fields_Node1 {
    $bc_ProphecyBenchmark3Levels2Fields_Node1(s->$v0, x, s->$v2, s->$v3, s->$v4, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node1'_v2(s: $bc_ProphecyBenchmark3Levels2Fields_Node1, x: int): $bc_ProphecyBenchmark3Levels2Fields_Node1 {
    $bc_ProphecyBenchmark3Levels2Fields_Node1(s->$v0, s->$v1, x, s->$v3, s->$v4, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node1'_v3(s: $bc_ProphecyBenchmark3Levels2Fields_Node1, x: int): $bc_ProphecyBenchmark3Levels2Fields_Node1 {
    $bc_ProphecyBenchmark3Levels2Fields_Node1(s->$v0, s->$v1, s->$v2, x, s->$v4, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node1'_v4(s: $bc_ProphecyBenchmark3Levels2Fields_Node1, x: int): $bc_ProphecyBenchmark3Levels2Fields_Node1 {
    $bc_ProphecyBenchmark3Levels2Fields_Node1(s->$v0, s->$v1, s->$v2, s->$v3, x, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node1'_v5(s: $bc_ProphecyBenchmark3Levels2Fields_Node1, x: int): $bc_ProphecyBenchmark3Levels2Fields_Node1 {
    $bc_ProphecyBenchmark3Levels2Fields_Node1(s->$v0, s->$v1, s->$v2, s->$v3, s->$v4, x, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node1'_v6(s: $bc_ProphecyBenchmark3Levels2Fields_Node1, x: int): $bc_ProphecyBenchmark3Levels2Fields_Node1 {
    $bc_ProphecyBenchmark3Levels2Fields_Node1(s->$v0, s->$v1, s->$v2, s->$v3, s->$v4, s->$v5, x, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node1'_v7(s: $bc_ProphecyBenchmark3Levels2Fields_Node1, x: int): $bc_ProphecyBenchmark3Levels2Fields_Node1 {
    $bc_ProphecyBenchmark3Levels2Fields_Node1(s->$v0, s->$v1, s->$v2, s->$v3, s->$v4, s->$v5, s->$v6, x)
}
function $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node1'(s: $bc_ProphecyBenchmark3Levels2Fields_Node1): bool {
    $IsValid'u64'(s->$v0)
      && $IsValid'u64'(s->$v1)
      && $IsValid'u64'(s->$v2)
      && $IsValid'u64'(s->$v3)
...
function {:inline} $IsEqual'$bc_ProphecyBenchmark3Levels2Fields_Node1'(s1: $bc_ProphecyBenchmark3Levels2Fields_Node1, s2: $bc_ProphecyBenchmark3Levels2Fields_Node1): bool {
    s1 == s2
}

// struct ProphecyBenchmark3Levels2Fields::Node2 at .\sources\ConditionalBorrowChain.move:14:5+147
datatype $bc_ProphecyBenchmark3Levels2Fields_Node2 {
    $bc_ProphecyBenchmark3Levels2Fields_Node2($v0: $bc_ProphecyBenchmark3Levels2Fields_Node1, $v1: $bc_ProphecyBenchmark3Levels2Fields_Node1, $v2: $bc_ProphecyBenchmark3Levels2Fields_Node1, $v3: $bc_ProphecyBenchmark3Levels2Fields_Node1, $v4: $bc_ProphecyBenchmark3Levels2Fields_Node1, $v5: $bc_ProphecyBenchmark3Levels2Fields_Node1, $v6: $bc_ProphecyBenchmark3Levels2Fields_Node1, $v7: $bc_ProphecyBenchmark3Levels2Fields_Node1)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node2'_v0(s: $bc_ProphecyBenchmark3Levels2Fields_Node2, x: $bc_ProphecyBenchmark3Levels2Fields_Node1): $bc_ProphecyBenchmark3Levels2Fields_Node2 {
    $bc_ProphecyBenchmark3Levels2Fields_Node2(x, s->$v1, s->$v2, s->$v3, s->$v4, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node2'_v1(s: $bc_ProphecyBenchmark3Levels2Fields_Node2, x: $bc_ProphecyBenchmark3Levels2Fields_Node1): $bc_ProphecyBenchmark3Levels2Fields_Node2 {
    $bc_ProphecyBenchmark3Levels2Fields_Node2(s->$v0, x, s->$v2, s->$v3, s->$v4, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node2'_v2(s: $bc_ProphecyBenchmark3Levels2Fields_Node2, x: $bc_ProphecyBenchmark3Levels2Fields_Node1): $bc_ProphecyBenchmark3Levels2Fields_Node2 {
    $bc_ProphecyBenchmark3Levels2Fields_Node2(s->$v0, s->$v1, x, s->$v3, s->$v4, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node2'_v3(s: $bc_ProphecyBenchmark3Levels2Fields_Node2, x: $bc_ProphecyBenchmark3Levels2Fields_Node1): $bc_ProphecyBenchmark3Levels2Fields_Node2 {
    $bc_ProphecyBenchmark3Levels2Fields_Node2(s->$v0, s->$v1, s->$v2, x, s->$v4, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node2'_v4(s: $bc_ProphecyBenchmark3Levels2Fields_Node2, x: $bc_ProphecyBenchmark3Levels2Fields_Node1): $bc_ProphecyBenchmark3Levels2Fields_Node2 {
    $bc_ProphecyBenchmark3Levels2Fields_Node2(s->$v0, s->$v1, s->$v2, s->$v3, x, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node2'_v5(s: $bc_ProphecyBenchmark3Levels2Fields_Node2, x: $bc_ProphecyBenchmark3Levels2Fields_Node1): $bc_ProphecyBenchmark3Levels2Fields_Node2 {
    $bc_ProphecyBenchmark3Levels2Fields_Node2(s->$v0, s->$v1, s->$v2, s->$v3, s->$v4, x, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node2'_v6(s: $bc_ProphecyBenchmark3Levels2Fields_Node2, x: $bc_ProphecyBenchmark3Levels2Fields_Node1): $bc_ProphecyBenchmark3Levels2Fields_Node2 {
    $bc_ProphecyBenchmark3Levels2Fields_Node2(s->$v0, s->$v1, s->$v2, s->$v3, s->$v4, s->$v5, x, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node2'_v7(s: $bc_ProphecyBenchmark3Levels2Fields_Node2, x: $bc_ProphecyBenchmark3Levels2Fields_Node1): $bc_ProphecyBenchmark3Levels2Fields_Node2 {
    $bc_ProphecyBenchmark3Levels2Fields_Node2(s->$v0, s->$v1, s->$v2, s->$v3, s->$v4, s->$v5, s->$v6, x)
}
function $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node2'(s: $bc_ProphecyBenchmark3Levels2Fields_Node2): bool {
    $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node1'(s->$v0)
      && $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node1'(s->$v1)
      && $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node1'(s->$v2)
      && $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node1'(s->$v3)
      && $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node1'(s->$v4)
      && $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node1'(s->$v5)
      && $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node1'(s->$v6)
      && $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node1'(s->$v7)
}
function {:inline} $IsEqual'$bc_ProphecyBenchmark3Levels2Fields_Node2'(s1: $bc_ProphecyBenchmark3Levels2Fields_Node2, s2: $bc_ProphecyBenchmark3Levels2Fields_Node2): bool {
    s1 == s2
}

// struct ProphecyBenchmark3Levels2Fields::Node3 at .\sources\ConditionalBorrowChain.move:20:5+147
datatype $bc_ProphecyBenchmark3Levels2Fields_Node3 {
    $bc_ProphecyBenchmark3Levels2Fields_Node3($v0: $bc_ProphecyBenchmark3Levels2Fields_Node2, $v1: $bc_ProphecyBenchmark3Levels2Fields_Node2, $v2: $bc_ProphecyBenchmark3Levels2Fields_Node2, $v3: $bc_ProphecyBenchmark3Levels2Fields_Node2, $v4: $bc_ProphecyBenchmark3Levels2Fields_Node2, $v5: $bc_ProphecyBenchmark3Levels2Fields_Node2, $v6: $bc_ProphecyBenchmark3Levels2Fields_Node2, $v7: $bc_ProphecyBenchmark3Levels2Fields_Node2)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node3'_v0(s: $bc_ProphecyBenchmark3Levels2Fields_Node3, x: $bc_ProphecyBenchmark3Levels2Fields_Node2): $bc_ProphecyBenchmark3Levels2Fields_Node3 {
    $bc_ProphecyBenchmark3Levels2Fields_Node3(x, s->$v1, s->$v2, s->$v3, s->$v4, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node3'_v1(s: $bc_ProphecyBenchmark3Levels2Fields_Node3, x: $bc_ProphecyBenchmark3Levels2Fields_Node2): $bc_ProphecyBenchmark3Levels2Fields_Node3 {
    $bc_ProphecyBenchmark3Levels2Fields_Node3(s->$v0, x, s->$v2, s->$v3, s->$v4, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node3'_v2(s: $bc_ProphecyBenchmark3Levels2Fields_Node3, x: $bc_ProphecyBenchmark3Levels2Fields_Node2): $bc_ProphecyBenchmark3Levels2Fields_Node3 {
    $bc_ProphecyBenchmark3Levels2Fields_Node3(s->$v0, s->$v1, x, s->$v3, s->$v4, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node3'_v3(s: $bc_ProphecyBenchmark3Levels2Fields_Node3, x: $bc_ProphecyBenchmark3Levels2Fields_Node2): $bc_ProphecyBenchmark3Levels2Fields_Node3 {
    $bc_ProphecyBenchmark3Levels2Fields_Node3(s->$v0, s->$v1, s->$v2, x, s->$v4, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node3'_v4(s: $bc_ProphecyBenchmark3Levels2Fields_Node3, x: $bc_ProphecyBenchmark3Levels2Fields_Node2): $bc_ProphecyBenchmark3Levels2Fields_Node3 {
    $bc_ProphecyBenchmark3Levels2Fields_Node3(s->$v0, s->$v1, s->$v2, s->$v3, x, s->$v5, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node3'_v5(s: $bc_ProphecyBenchmark3Levels2Fields_Node3, x: $bc_ProphecyBenchmark3Levels2Fields_Node2): $bc_ProphecyBenchmark3Levels2Fields_Node3 {
    $bc_ProphecyBenchmark3Levels2Fields_Node3(s->$v0, s->$v1, s->$v2, s->$v3, s->$v4, x, s->$v6, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node3'_v6(s: $bc_ProphecyBenchmark3Levels2Fields_Node3, x: $bc_ProphecyBenchmark3Levels2Fields_Node2): $bc_ProphecyBenchmark3Levels2Fields_Node3 {
    $bc_ProphecyBenchmark3Levels2Fields_Node3(s->$v0, s->$v1, s->$v2, s->$v3, s->$v4, s->$v5, x, s->$v7)
}
function {:inline} $Update'$bc_ProphecyBenchmark3Levels2Fields_Node3'_v7(s: $bc_ProphecyBenchmark3Levels2Fields_Node3, x: $bc_ProphecyBenchmark3Levels2Fields_Node2): $bc_ProphecyBenchmark3Levels2Fields_Node3 {
    $bc_ProphecyBenchmark3Levels2Fields_Node3(s->$v0, s->$v1, s->$v2, s->$v3, s->$v4, s->$v5, s->$v6, x)
}
function $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node3'(s: $bc_ProphecyBenchmark3Levels2Fields_Node3): bool {
    $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node2'(s->$v0)
      && $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node2'(s->$v1)
      && $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node2'(s->$v2)
      && $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node2'(s->$v3)
      && $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node2'(s->$v4)
      && $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node2'(s->$v5)
      && $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node2'(s->$v6)
      && $IsValid'$bc_ProphecyBenchmark3Levels2Fields_Node2'(s->$v7)
}
function {:inline} $IsEqual'$bc_ProphecyBenchmark3Levels2Fields_Node3'(s1: $bc_ProphecyBenchmark3Levels2Fields_Node3, s2: $bc_ProphecyBenchmark3Levels2Fields_Node3): bool {
    s1 == s2
}

// fun ProphecyBenchmark3Levels2Fields::benchmark_from_scratch [verification] at .\sources\ConditionalBorrowChain.move:82:5+500
procedure {:timeLimit 40} $bc_ProphecyBenchmark3Levels2Fields_benchmark_from_scratch$verify(_$t0: int, _$t1: int, _$t2: int) returns ($ret0: $bc_ProphecyBenchmark3Levels2Fields_Node3)
{
    // declare local variables
    var $t3: $bc_ProphecyBenchmark3Levels2Fields_Node3;
    var $t4: $Mutation (int);
    var $t5: int;
    var $t6: int;
    var $t7: int;
    ...
    var $t10: int;
    var $t11: int;
    var $t12: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node3);
    var $t13: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node2);
    var $t14: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node1);
    ...
    var $t57: bool;
    var $t58: bool;
    var $t59: $bc_ProphecyBenchmark3Levels2Fields_Node3;
    var $t0: int;
    var $t1: int;
    var $t2: int;
    var $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node3': $bc_ProphecyBenchmark3Levels2Fields_Node3;
    var $temp_0'u64': int;
    $t0 := _$t0;
    $t1 := _$t1;
    $t2 := _$t2;
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at .\sources\ConditionalBorrowChain.move:82:5+1
    assume {:print "$at(3,2523,2524)"} true;
    assume $IsValid'u64'($t0);

    // assume WellFormed($t1) at .\sources\ConditionalBorrowChain.move:82:5+1
    assume $IsValid'u64'($t1);

    // assume WellFormed($t2) at .\sources\ConditionalBorrowChain.move:82:5+1
    assume $IsValid'u64'($t2);

    // trace_local[c3]($t0) at .\sources\ConditionalBorrowChain.move:82:5+1
    assume {:print "$track_local(4,0,0):", $t0} $t0 == $t0;

    // trace_local[c2]($t1) at .\sources\ConditionalBorrowChain.move:82:5+1
    assume {:print "$track_local(4,0,1):", $t1} $t1 == $t1;

    // trace_local[c1]($t2) at .\sources\ConditionalBorrowChain.move:82:5+1
    assume {:print "$track_local(4,0,2):", $t2} $t2 == $t2;

    // $t3 := ProphecyBenchmark3Levels2Fields::new_node3() on_abort goto L18 with $t5 at .\sources\ConditionalBorrowChain.move:85:20+11
    assume {:print "$at(3,2626,2637)"} true;
    call $t3 := $bc_ProphecyBenchmark3Levels2Fields_new_node3();
    if ($abort_flag) {
        assume {:print "$at(3,2626,2637)"} true;
        $t5 := $abort_code;
    ...
    // trace_local[root]($t3) at .\sources\ConditionalBorrowChain.move:85:20+11
    assume {:print "$track_local(4,0,3):", $t3} $t3 == $t3;

    // $t6 := 8 at .\sources\ConditionalBorrowChain.move:87:25+1
    assume {:print "$at(3,2672,2673)"} true;
    $t6 := 8;
    assume $IsValid'u64'($t6);

    // $t7 := %($t0, $t6) on_abort goto L18 with $t5 at .\sources\ConditionalBorrowChain.move:87:20+6
    call $t7 := $Mod($t0, $t6);
    if ($abort_flag) {
        assume {:print "$at(3,2667,2673)"} true;
        $t5 := $abort_code;
        assume {:print "$track_abort(4,0):", $t5} $t5 == $t5;
        goto L18;
    }

    // trace_local[c3]($t7) at .\sources\ConditionalBorrowChain.move:87:20+6
    assume {:print "$track_local(4,0,0):", $t7} $t7 == $t7;

    // $t8 := 8 at .\sources\ConditionalBorrowChain.move:88:25+1
    assume {:print "$at(3,2699,2700)"} true;
    $t8 := 8;
    assume $IsValid'u64'($t8);

    // $t9 := %($t1, $t8) on_abort goto L18 with $t5 at .\sources\ConditionalBorrowChain.move:88:20+6
    call $t9 := $Mod($t1, $t8);
    if ($abort_flag) {
        assume {:print "$at(3,2694,2700)"} true;
        $t5 := $abort_code;
        assume {:print "$track_abort(4,0):", $t5} $t5 == $t5;
        goto L18;
    }

    // trace_local[c2]($t9) at .\sources\ConditionalBorrowChain.move:88:20+6
    assume {:print "$track_local(4,0,1):", $t9} $t9 == $t9;

    // $t10 := 8 at .\sources\ConditionalBorrowChain.move:89:25+1
    assume {:print "$at(3,2726,2727)"} true;
    $t10 := 8;
    assume $IsValid'u64'($t10);

    // $t11 := %($t2, $t10) on_abort goto L18 with $t5 at .\sources\ConditionalBorrowChain.move:89:20+6
    call $t11 := $Mod($t2, $t10);
    if ($abort_flag) {
        assume {:print "$at(3,2721,2727)"} true;
        $t5 := $abort_code;
        assume {:print "$track_abort(4,0):", $t5} $t5 == $t5;
        goto L18;
    }

    // trace_local[c1]($t11) at .\sources\ConditionalBorrowChain.move:89:20+6
    assume {:print "$track_local(4,0,2):", $t11} $t11 == $t11;

    // $t12 := borrow_local($t3) at .\sources\ConditionalBorrowChain.move:91:22+9
    assume {:print "$at(3,2751,2760)"} true;
    $t12 := $Mutation($Local(3), EmptyVec(), $t3);

    // $t13 := ProphecyBenchmark3Levels2Fields::select_n2($t12, $t7) on_abort goto L18 with $t5 at .\sources\ConditionalBorrowChain.move:94:22+23
    assume {:print "$at(3,2848,2871)"} true;
    call $t13,$t12 := $bc_ProphecyBenchmark3Levels2Fields_select_n2($t12, $t7);
    if ($abort_flag) {
        assume {:print "$at(3,2848,2871)"} true;
        $t5 := $abort_code;
        assume {:print "$track_abort(4,0):", $t5} $t5 == $t5;
    ...
    // $t14 := ProphecyBenchmark3Levels2Fields::select_n1($t13, $t9) on_abort goto L18 with $t5 at .\sources\ConditionalBorrowChain.move:95:22+23
    assume {:print "$at(3,2894,2917)"} true;
    call $t14,$t13 := $bc_ProphecyBenchmark3Levels2Fields_select_n1($t13, $t9);
    if ($abort_flag) {
        assume {:print "$at(3,2894,2917)"} true;
        $t5 := $abort_code;
        assume {:print "$track_abort(4,0):", $t5} $t5 == $t5;
    ...
    // $t15 := ProphecyBenchmark3Levels2Fields::select_leaf($t14, $t11) on_abort goto L18 with $t5 at .\sources\ConditionalBorrowChain.move:96:24+25
    assume {:print "$at(3,2942,2967)"} true;
    call $t15,$t14 := $bc_ProphecyBenchmark3Levels2Fields_select_leaf($t14, $t11);
    if ($abort_flag) {
        assume {:print "$at(3,2942,2967)"} true;
        $t5 := $abort_code;
        assume {:print "$track_abort(4,0):", $t5} $t5 == $t5;
    ...
    // trace_local[leaf_ref]($t15) at .\sources\ConditionalBorrowChain.move:96:24+25
    $temp_0'u64' := $Dereference($t15);
    assume {:print "$track_local(4,0,4):", $temp_0'u64'} $temp_0'u64' == $temp_0'u64';

    // $t16 := read_ref($t15) at .\sources\ConditionalBorrowChain.move:97:21+9
    assume {:print "$at(3,2989,2998)"} true;
    $t16 := $Dereference($t15);

    // $t17 := 1 at .\sources\ConditionalBorrowChain.move:97:33+1
    $t17 := 1;
    assume $IsValid'u64'($t17);

    // $t18 := +($t16, $t17) on_abort goto L18 with $t5 at .\sources\ConditionalBorrowChain.move:97:21+13
    call $t18 := $AddU64($t16, $t17);
    if ($abort_flag) {
        assume {:print "$at(3,2989,3002)"} true;
        $t5 := $abort_code;
        assume {:print "$track_abort(4,0):", $t5} $t5 == $t5;
        goto L18;
    }

    // write_ref($t15, $t18) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t15 := $UpdateMutation($t15, $t18);

    // $t19 := is_parent[Reference($t14).v0 (u64)]($t15) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t19 := $IsParentMutation($t14, 0, $t15);

    // $t20 := is_parent[Reference($t13).v0 (0xbc::ProphecyBenchmark3Levels2Fields::Node1)]($t14) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t20 := $IsParentMutation($t13, 0, $t14);

    // $t21 := &&($t19, $t20) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t21 := $And($t19, $t20);

    // $t22 := is_parent[Reference($t12).v0 (0xbc::ProphecyBenchmark3Levels2Fields::Node2)]($t13) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t22 := $IsParentMutation($t12, 0, $t13);

    // $t23 := &&($t21, $t22) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t23 := $And($t21, $t22);

    // if ($t23) goto L1 else goto L2 at .\sources\ConditionalBorrowChain.move:97:9+25
    if ($t23) { goto L1; } else { goto L2; }

    // label L1 at .\sources\ConditionalBorrowChain.move:97:9+25
L1:

    // write_back[Reference($t14).v0 (u64)]($t15) at .\sources\ConditionalBorrowChain.move:97:9+25
    assume {:print "$at(3,2977,3002)"} true;
    $t14 := $UpdateMutation($t14, $Update'$bc_ProphecyBenchmark3Levels2Fields_Node1'_v0($Dereference($t14), $Dereference($t15)));

    // write_back[Reference($t13).v0 (0xbc::ProphecyBenchmark3Levels2Fields::Node1)]($t14) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t13 := $UpdateMutation($t13, $Update'$bc_ProphecyBenchmark3Levels2Fields_Node2'_v0($Dereference($t13), $Dereference($t14)));

    // write_back[Reference($t12).v0 (0xbc::ProphecyBenchmark3Levels2Fields::Node2)]($t13) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t12 := $UpdateMutation($t12, $Update'$bc_ProphecyBenchmark3Levels2Fields_Node3'_v0($Dereference($t12), $Dereference($t13)));

    // write_back[LocalRoot($t3)@]($t12) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t3 := $Dereference($t12);

    // trace_local[root]($t3) at .\sources\ConditionalBorrowChain.move:97:9+25
    assume {:print "$track_local(4,0,3):", $t3} $t3 == $t3;

    // label L2 at .\sources\ConditionalBorrowChain.move:97:9+25
L2:

    // $t24 := is_parent[Reference($t14).v0 (u64)]($t15) at .\sources\ConditionalBorrowChain.move:97:9+25
    assume {:print "$at(3,2977,3002)"} true;
    $t24 := $IsParentMutation($t14, 0, $t15);

    // $t25 := is_parent[Reference($t13).v0 (0xbc::ProphecyBenchmark3Levels2Fields::Node1)]($t14) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t25 := $IsParentMutation($t13, 0, $t14);

    // $t26 := &&($t24, $t25) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t26 := $And($t24, $t25);

    // $t27 := is_parent[Reference($t12).v1 (0xbc::ProphecyBenchmark3Levels2Fields::Node2)]($t13) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t27 := $IsParentMutation($t12, 1, $t13);

    // $t28 := &&($t26, $t27) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t28 := $And($t26, $t27);

    // if ($t28) goto L3 else goto L4 at .\sources\ConditionalBorrowChain.move:97:9+25
    if ($t28) { goto L3; } else { goto L4; }

    // label L3 at .\sources\ConditionalBorrowChain.move:97:9+25
L3:
    ...
    // write_back[Reference($t12).v1 (0xbc::ProphecyBenchmark3Levels2Fields::Node2)]($t13) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t12 := $UpdateMutation($t12, $Update'$bc_ProphecyBenchmark3Levels2Fields_Node3'_v1($Dereference($t12), $Dereference($t13)));
    ...
    // label L4 at .\sources\ConditionalBorrowChain.move:97:9+25
L4:

    // $t29 := is_parent[Reference($t14).v0 (u64)]($t15) at .\sources\ConditionalBorrowChain.move:97:9+25
    assume {:print "$at(3,2977,3002)"} true;
    $t29 := $IsParentMutation($t14, 0, $t15);

    // $t30 := is_parent[Reference($t13).v1 (0xbc::ProphecyBenchmark3Levels2Fields::Node1)]($t14) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t30 := $IsParentMutation($t13, 1, $t14);

    // $t31 := &&($t29, $t30) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t31 := $And($t29, $t30);

    // $t32 := is_parent[Reference($t12).v0 (0xbc::ProphecyBenchmark3Levels2Fields::Node2)]($t13) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t32 := $IsParentMutation($t12, 0, $t13);

    // $t33 := &&($t31, $t32) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t33 := $And($t31, $t32);

    // if ($t33) goto L5 else goto L6 at .\sources\ConditionalBorrowChain.move:97:9+25
    if ($t33) { goto L5; } else { goto L6; }

    // label L5 at .\sources\ConditionalBorrowChain.move:97:9+25
L5:
    ...
    // write_back[Reference($t13).v1 (0xbc::ProphecyBenchmark3Levels2Fields::Node1)]($t14) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t13 := $UpdateMutation($t13, $Update'$bc_ProphecyBenchmark3Levels2Fields_Node2'_v1($Dereference($t13), $Dereference($t14)));
    ...
    // label L6 at .\sources\ConditionalBorrowChain.move:97:9+25
L6:

    // $t34 := is_parent[Reference($t14).v0 (u64)]($t15) at .\sources\ConditionalBorrowChain.move:97:9+25
    assume {:print "$at(3,2977,3002)"} true;
    $t34 := $IsParentMutation($t14, 0, $t15);

    // $t35 := is_parent[Reference($t13).v1 (0xbc::ProphecyBenchmark3Levels2Fields::Node1)]($t14) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t35 := $IsParentMutation($t13, 1, $t14);

    // $t36 := &&($t34, $t35) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t36 := $And($t34, $t35);

    // $t37 := is_parent[Reference($t12).v1 (0xbc::ProphecyBenchmark3Levels2Fields::Node2)]($t13) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t37 := $IsParentMutation($t12, 1, $t13);

    // $t38 := &&($t36, $t37) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t38 := $And($t36, $t37);

    // if ($t38) goto L7 else goto L8 at .\sources\ConditionalBorrowChain.move:97:9+25
    if ($t38) { goto L7; } else { goto L8; }

    // label L7 at .\sources\ConditionalBorrowChain.move:97:9+25
L7:
    ...
    // label L8 at .\sources\ConditionalBorrowChain.move:97:9+25
L8:

    // $t39 := is_parent[Reference($t14).v1 (u64)]($t15) at .\sources\ConditionalBorrowChain.move:97:9+25
    assume {:print "$at(3,2977,3002)"} true;
    $t39 := $IsParentMutation($t14, 1, $t15);

    // $t40 := is_parent[Reference($t13).v0 (0xbc::ProphecyBenchmark3Levels2Fields::Node1)]($t14) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t40 := $IsParentMutation($t13, 0, $t14);

    // $t41 := &&($t39, $t40) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t41 := $And($t39, $t40);

    // $t42 := is_parent[Reference($t12).v0 (0xbc::ProphecyBenchmark3Levels2Fields::Node2)]($t13) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t42 := $IsParentMutation($t12, 0, $t13);

    // $t43 := &&($t41, $t42) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t43 := $And($t41, $t42);

    // if ($t43) goto L9 else goto L10 at .\sources\ConditionalBorrowChain.move:97:9+25
    if ($t43) { goto L9; } else { goto L10; }

    // label L9 at .\sources\ConditionalBorrowChain.move:97:9+25
L9:

    // write_back[Reference($t14).v1 (u64)]($t15) at .\sources\ConditionalBorrowChain.move:97:9+25
    assume {:print "$at(3,2977,3002)"} true;
    $t14 := $UpdateMutation($t14, $Update'$bc_ProphecyBenchmark3Levels2Fields_Node1'_v1($Dereference($t14), $Dereference($t15)));
    ...
    // label L10 at .\sources\ConditionalBorrowChain.move:97:9+25
L10:

    // $t44 := is_parent[Reference($t14).v1 (u64)]($t15) at .\sources\ConditionalBorrowChain.move:97:9+25
    assume {:print "$at(3,2977,3002)"} true;
    $t44 := $IsParentMutation($t14, 1, $t15);

    // $t45 := is_parent[Reference($t13).v0 (0xbc::ProphecyBenchmark3Levels2Fields::Node1)]($t14) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t45 := $IsParentMutation($t13, 0, $t14);

    // $t46 := &&($t44, $t45) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t46 := $And($t44, $t45);

    // $t47 := is_parent[Reference($t12).v1 (0xbc::ProphecyBenchmark3Levels2Fields::Node2)]($t13) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t47 := $IsParentMutation($t12, 1, $t13);

    // $t48 := &&($t46, $t47) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t48 := $And($t46, $t47);

    // if ($t48) goto L11 else goto L12 at .\sources\ConditionalBorrowChain.move:97:9+25
    if ($t48) { goto L11; } else { goto L12; }

    // label L11 at .\sources\ConditionalBorrowChain.move:97:9+25
L11:
    ...
    // label L12 at .\sources\ConditionalBorrowChain.move:97:9+25
L12:

    // $t49 := is_parent[Reference($t14).v1 (u64)]($t15) at .\sources\ConditionalBorrowChain.move:97:9+25
    assume {:print "$at(3,2977,3002)"} true;
    $t49 := $IsParentMutation($t14, 1, $t15);

    // $t50 := is_parent[Reference($t13).v1 (0xbc::ProphecyBenchmark3Levels2Fields::Node1)]($t14) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t50 := $IsParentMutation($t13, 1, $t14);

    // $t51 := &&($t49, $t50) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t51 := $And($t49, $t50);

    // $t52 := is_parent[Reference($t12).v0 (0xbc::ProphecyBenchmark3Levels2Fields::Node2)]($t13) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t52 := $IsParentMutation($t12, 0, $t13);

    // $t53 := &&($t51, $t52) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t53 := $And($t51, $t52);

    // if ($t53) goto L13 else goto L14 at .\sources\ConditionalBorrowChain.move:97:9+25
    if ($t53) { goto L13; } else { goto L14; }

    // label L13 at .\sources\ConditionalBorrowChain.move:97:9+25
L13:
    ...
    // label L14 at .\sources\ConditionalBorrowChain.move:97:9+25
L14:

    // $t54 := is_parent[Reference($t14).v1 (u64)]($t15) at .\sources\ConditionalBorrowChain.move:97:9+25
    assume {:print "$at(3,2977,3002)"} true;
    $t54 := $IsParentMutation($t14, 1, $t15);

    // $t55 := is_parent[Reference($t13).v1 (0xbc::ProphecyBenchmark3Levels2Fields::Node1)]($t14) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t55 := $IsParentMutation($t13, 1, $t14);

    // $t56 := &&($t54, $t55) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t56 := $And($t54, $t55);

    // $t57 := is_parent[Reference($t12).v1 (0xbc::ProphecyBenchmark3Levels2Fields::Node2)]($t13) at .\sources\ConditionalBorrowChain.move:97:9+25
    $t57 := $IsParentMutation($t12, 1, $t13);

    // $t58 := &&($t56, $t57) at .\sources\ConditionalBorrowChain.move:97:9+25
    call $t58 := $And($t56, $t57);

    // if ($t58) goto L15 else goto L19 at .\sources\ConditionalBorrowChain.move:97:9+25
    if ($t58) { goto L15; } else { goto L19; }

    // label L15 at .\sources\ConditionalBorrowChain.move:97:9+25
L15:
    ...
    // label L16 at .\sources\ConditionalBorrowChain.move:97:9+25
L16:

    // $t59 := move($t3) at .\sources\ConditionalBorrowChain.move:99:9+4
    assume {:print "$at(3,3013,3017)"} true;
    $t59 := $t3;

    // trace_return[0]($t59) at .\sources\ConditionalBorrowChain.move:84:14+418
    assume {:print "$at(3,2605,3023)"} true;
    assume {:print "$track_return(4,0,0):", $t59} $t59 == $t59;

    // label L17 at .\sources\ConditionalBorrowChain.move:100:5+1
    assume {:print "$at(3,3022,3023)"} true;
L17:

    // assert Implies(And(And(Eq<u64>($t0, 0), Eq<u64>($t1, 0)), Eq<u64>($t2, 0)), Eq<u64>(select ProphecyBenchmark3Levels2Fields::Node1.v0<0xbc::ProphecyBenchmark3Levels2Fields::Node1>(select ProphecyBenchmark3Levels2Fields::Node2.v0<0xbc::ProphecyBenchmark3Levels2Fields::Node2>(select ProphecyBenchmark3Levels2Fields::Node3.v0<0xbc::ProphecyBenchmark3Levels2Fields::Node3>($t59))), 1)) at .\sources\ConditionalBorrowChain.move:116:9+72
    assume {:print "$at(3,3358,3430)"} true;
    assert {:msg "assert_failed(3,3358,3430): post-condition does not hold"}
      ((($IsEqual'u64'($t0, 0) && $IsEqual'u64'($t1, 0)) && $IsEqual'u64'($t2, 0)) ==> $IsEqual'u64'($t59->$v0->$v0->$v0, 1));

    // assert Implies(Or(Or(Neq<num>(Mod($t0, 8), 0), Neq<num>(Mod($t1, 8), 0)), Neq<num>(Mod($t2, 8), 0)), Eq<u64>(select ProphecyBenchmark3Levels2Fields::Node1.v0<0xbc::ProphecyBenchmark3Levels2Fields::Node1>(select ProphecyBenchmark3Levels2Fields::Node2.v0<0xbc::ProphecyBenchmark3Levels2Fields::Node2>(select ProphecyBenchmark3Levels2Fields::Node3.v0<0xbc::ProphecyBenchmark3Levels2Fields::Node3>($t59))), 0)) at .\sources\ConditionalBorrowChain.move:120:9+78
    assume {:print "$at(3,3506,3584)"} true;
    assert {:msg "assert_failed(3,3506,3584): post-condition does not hold"}
      (((!$IsEqual'num'(($t0 mod 8), 0) || !$IsEqual'num'(($t1 mod 8), 0)) || !$IsEqual'num'(($t2 mod 8), 0)) ==> $IsEqual'u64'($t59->$v0->$v0->$v0, 0));

    // assert Le(select ProphecyBenchmark3Levels2Fields::Node1.v0<0xbc::ProphecyBenchmark3Levels2Fields::Node1>(select ProphecyBenchmark3Levels2Fields::Node2.v0<0xbc::ProphecyBenchmark3Levels2Fields::Node2>(select ProphecyBenchmark3Levels2Fields::Node3.v0<0xbc::ProphecyBenchmark3Levels2Fields::Node3>($t59))), 1) at .\sources\ConditionalBorrowChain.move:124:9+29
    assume {:print "$at(3,3632,3661)"} true;
    assert {:msg "assert_failed(3,3632,3661): post-condition does not hold"}
      ($t59->$v0->$v0->$v0 <= 1);

    // return $t59 at .\sources\ConditionalBorrowChain.move:124:9+29
    $ret0 := $t59;
    return;

    // label L18 at .\sources\ConditionalBorrowChain.move:100:5+1
    assume {:print "$at(3,3022,3023)"} true;
L18:

    // abort($t5) at .\sources\ConditionalBorrowChain.move:100:5+1
    assume {:print "$at(3,3022,3023)"} true;
    $abort_code := $t5;
    $abort_flag := true;
    return;
...
// fun ProphecyBenchmark3Levels2Fields::new_node1 [baseline] at .\sources\ConditionalBorrowChain.move:29:5+110
procedure {:inline 1} $bc_ProphecyBenchmark3Levels2Fields_new_node1() returns ($ret0: $bc_ProphecyBenchmark3Levels2Fields_Node1)
{
    // declare local variables
    var $t0: int;
    var $t1: int;
    ...
    var $t6: int;
    var $t7: int;
    var $t8: $bc_ProphecyBenchmark3Levels2Fields_Node1;
    var $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1': $bc_ProphecyBenchmark3Levels2Fields_Node1;
    ...
    // $t8 := pack 0xbc::ProphecyBenchmark3Levels2Fields::Node1($t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7) at .\sources\ConditionalBorrowChain.move:30:9+64
    $t8 := $bc_ProphecyBenchmark3Levels2Fields_Node1($t0, $t1, $t2, $t3, $t4, $t5, $t6, $t7);
...
// fun ProphecyBenchmark3Levels2Fields::new_node1 [verification] at .\sources\ConditionalBorrowChain.move:29:5+110
procedure {:timeLimit 40} $bc_ProphecyBenchmark3Levels2Fields_new_node1$verify() returns ($ret0: $bc_ProphecyBenchmark3Levels2Fields_Node1)
{
    // declare local variables
    var $t0: int;
    var $t1: int;
...
// fun ProphecyBenchmark3Levels2Fields::new_node2 [baseline] at .\sources\ConditionalBorrowChain.move:33:5+225
procedure {:inline 1} $bc_ProphecyBenchmark3Levels2Fields_new_node2() returns ($ret0: $bc_ProphecyBenchmark3Levels2Fields_Node2)
{
    // declare local variables
    var $t0: $bc_ProphecyBenchmark3Levels2Fields_Node1;
    var $t1: int;
    var $t2: $bc_ProphecyBenchmark3Levels2Fields_Node1;
    var $t3: $bc_ProphecyBenchmark3Levels2Fields_Node1;
    var $t4: $bc_ProphecyBenchmark3Levels2Fields_Node1;
    var $t5: $bc_ProphecyBenchmark3Levels2Fields_Node1;
    var $t6: $bc_ProphecyBenchmark3Levels2Fields_Node1;
    var $t7: $bc_ProphecyBenchmark3Levels2Fields_Node1;
    var $t8: $bc_ProphecyBenchmark3Levels2Fields_Node1;
    var $t9: $bc_ProphecyBenchmark3Levels2Fields_Node2;
    var $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2': $bc_ProphecyBenchmark3Levels2Fields_Node2;

    // bytecode translation starts here
    // $t0 := ProphecyBenchmark3Levels2Fields::new_node1() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:35:17+11
    assume {:print "$at(3,1060,1071)"} true;
    call $t0 := $bc_ProphecyBenchmark3Levels2Fields_new_node1();
    if ($abort_flag) {
        assume {:print "$at(3,1060,1071)"} true;
        $t1 := $abort_code;
    ...
    // $t2 := ProphecyBenchmark3Levels2Fields::new_node1() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:35:34+11
    call $t2 := $bc_ProphecyBenchmark3Levels2Fields_new_node1();
    if ($abort_flag) {
    ...
    // $t3 := ProphecyBenchmark3Levels2Fields::new_node1() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:35:51+11
    call $t3 := $bc_ProphecyBenchmark3Levels2Fields_new_node1();
    if ($abort_flag) {
    ...
    // $t4 := ProphecyBenchmark3Levels2Fields::new_node1() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:35:68+11
    call $t4 := $bc_ProphecyBenchmark3Levels2Fields_new_node1();
    if ($abort_flag) {
    ...
    // $t5 := ProphecyBenchmark3Levels2Fields::new_node1() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:36:17+11
    assume {:print "$at(3,1141,1152)"} true;
    call $t5 := $bc_ProphecyBenchmark3Levels2Fields_new_node1();
    if ($abort_flag) {
        assume {:print "$at(3,1141,1152)"} true;
        $t1 := $abort_code;
        assume {:print "$track_abort(4,2):", $t1} $t1 == $t1;
    ...
    // $t6 := ProphecyBenchmark3Levels2Fields::new_node1() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:36:34+11
    call $t6 := $bc_ProphecyBenchmark3Levels2Fields_new_node1();
    if ($abort_flag) {
    ...
    // $t7 := ProphecyBenchmark3Levels2Fields::new_node1() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:36:51+11
    call $t7 := $bc_ProphecyBenchmark3Levels2Fields_new_node1();
    if ($abort_flag) {
    ...
    // $t8 := ProphecyBenchmark3Levels2Fields::new_node1() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:36:68+11
    call $t8 := $bc_ProphecyBenchmark3Levels2Fields_new_node1();
    if ($abort_flag) {
    ...
    // $t9 := pack 0xbc::ProphecyBenchmark3Levels2Fields::Node2($t0, $t2, $t3, $t4, $t5, $t6, $t7, $t8) at .\sources\ConditionalBorrowChain.move:34:9+179
    assume {:print "$at(3,1035,1214)"} true;
    $t9 := $bc_ProphecyBenchmark3Levels2Fields_Node2($t0, $t2, $t3, $t4, $t5, $t6, $t7, $t8);
...
// fun ProphecyBenchmark3Levels2Fields::new_node2 [verification] at .\sources\ConditionalBorrowChain.move:33:5+225
procedure {:timeLimit 40} $bc_ProphecyBenchmark3Levels2Fields_new_node2$verify() returns ($ret0: $bc_ProphecyBenchmark3Levels2Fields_Node2)
{
    // declare local variables
    var $t0: $bc_ProphecyBenchmark3Levels2Fields_Node1;
    var $t1: int;
...
// fun ProphecyBenchmark3Levels2Fields::new_node3 [baseline] at .\sources\ConditionalBorrowChain.move:40:5+225
procedure {:inline 1} $bc_ProphecyBenchmark3Levels2Fields_new_node3() returns ($ret0: $bc_ProphecyBenchmark3Levels2Fields_Node3)
{
    // declare local variables
    var $t0: $bc_ProphecyBenchmark3Levels2Fields_Node2;
    var $t1: int;
    var $t2: $bc_ProphecyBenchmark3Levels2Fields_Node2;
    var $t3: $bc_ProphecyBenchmark3Levels2Fields_Node2;
    var $t4: $bc_ProphecyBenchmark3Levels2Fields_Node2;
    var $t5: $bc_ProphecyBenchmark3Levels2Fields_Node2;
    var $t6: $bc_ProphecyBenchmark3Levels2Fields_Node2;
    var $t7: $bc_ProphecyBenchmark3Levels2Fields_Node2;
    var $t8: $bc_ProphecyBenchmark3Levels2Fields_Node2;
    var $t9: $bc_ProphecyBenchmark3Levels2Fields_Node3;
    var $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node3': $bc_ProphecyBenchmark3Levels2Fields_Node3;

    // bytecode translation starts here
    // $t0 := ProphecyBenchmark3Levels2Fields::new_node2() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:42:17+11
    assume {:print "$at(3,1291,1302)"} true;
    call $t0 := $bc_ProphecyBenchmark3Levels2Fields_new_node2();
    if ($abort_flag) {
        assume {:print "$at(3,1291,1302)"} true;
        $t1 := $abort_code;
    ...
    // $t2 := ProphecyBenchmark3Levels2Fields::new_node2() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:42:34+11
    call $t2 := $bc_ProphecyBenchmark3Levels2Fields_new_node2();
    if ($abort_flag) {
    ...
    // $t3 := ProphecyBenchmark3Levels2Fields::new_node2() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:42:51+11
    call $t3 := $bc_ProphecyBenchmark3Levels2Fields_new_node2();
    if ($abort_flag) {
    ...
    // $t4 := ProphecyBenchmark3Levels2Fields::new_node2() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:42:68+11
    call $t4 := $bc_ProphecyBenchmark3Levels2Fields_new_node2();
    if ($abort_flag) {
    ...
    // $t5 := ProphecyBenchmark3Levels2Fields::new_node2() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:43:17+11
    assume {:print "$at(3,1372,1383)"} true;
    call $t5 := $bc_ProphecyBenchmark3Levels2Fields_new_node2();
    if ($abort_flag) {
        assume {:print "$at(3,1372,1383)"} true;
        $t1 := $abort_code;
        assume {:print "$track_abort(4,3):", $t1} $t1 == $t1;
    ...
    // $t6 := ProphecyBenchmark3Levels2Fields::new_node2() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:43:34+11
    call $t6 := $bc_ProphecyBenchmark3Levels2Fields_new_node2();
    if ($abort_flag) {
    ...
    // $t7 := ProphecyBenchmark3Levels2Fields::new_node2() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:43:51+11
    call $t7 := $bc_ProphecyBenchmark3Levels2Fields_new_node2();
    if ($abort_flag) {
    ...
    // $t8 := ProphecyBenchmark3Levels2Fields::new_node2() on_abort goto L2 with $t1 at .\sources\ConditionalBorrowChain.move:43:68+11
    call $t8 := $bc_ProphecyBenchmark3Levels2Fields_new_node2();
    if ($abort_flag) {
    ...
    // $t9 := pack 0xbc::ProphecyBenchmark3Levels2Fields::Node3($t0, $t2, $t3, $t4, $t5, $t6, $t7, $t8) at .\sources\ConditionalBorrowChain.move:41:9+179
    assume {:print "$at(3,1266,1445)"} true;
    $t9 := $bc_ProphecyBenchmark3Levels2Fields_Node3($t0, $t2, $t3, $t4, $t5, $t6, $t7, $t8);
...
// fun ProphecyBenchmark3Levels2Fields::new_node3 [verification] at .\sources\ConditionalBorrowChain.move:40:5+225
procedure {:timeLimit 40} $bc_ProphecyBenchmark3Levels2Fields_new_node3$verify() returns ($ret0: $bc_ProphecyBenchmark3Levels2Fields_Node3)
{
    // declare local variables
    var $t0: $bc_ProphecyBenchmark3Levels2Fields_Node2;
    var $t1: int;
...
// fun ProphecyBenchmark3Levels2Fields::select_leaf [baseline] at .\sources\ConditionalBorrowChain.move:70:5+113
procedure {:inline 1} $bc_ProphecyBenchmark3Levels2Fields_select_leaf(_$t0: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node1), _$t1: int) returns ($ret0: $Mutation (int), $ret1: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node1))
{
    // declare local variables
    var $t2: int;
    var $t3: bool;
    ...
    var $t5: $Mutation (int);
    var $t6: $Mutation (int);
    var $t0: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node1);
    var $t1: int;
    var $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1': $bc_ProphecyBenchmark3Levels2Fields_Node1;
    var $temp_0'u64': int;
    $t0 := _$t0;
    ...
    // bytecode translation starts here
    // trace_local[n]($t0) at .\sources\ConditionalBorrowChain.move:70:5+1
    assume {:print "$at(3,2175,2176)"} true;
    $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1' := $Dereference($t0);
    assume {:print "$track_local(4,4,0):", $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1'} $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1' == $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1';

    // trace_local[idx]($t1) at .\sources\ConditionalBorrowChain.move:70:5+1
    assume {:print "$track_local(4,4,1):", $t1} $t1 == $t1;

    // $t2 := 0 at .\sources\ConditionalBorrowChain.move:71:20+1
    assume {:print "$at(3,2247,2248)"} true;
    $t2 := 0;
    assume $IsValid'u64'($t2);

    // $t3 := ==($t1, $t2) at .\sources\ConditionalBorrowChain.move:71:13+8
    $t3 := $IsEqual'u64'($t1, $t2);

    // if ($t3) goto L1 else goto L0 at .\sources\ConditionalBorrowChain.move:71:9+46
    if ($t3) { goto L1; } else { goto L0; }

    // label L1 at .\sources\ConditionalBorrowChain.move:71:25+9
L1:

    // $t4 := borrow_field<0xbc::ProphecyBenchmark3Levels2Fields::Node1>.v0($t0) at .\sources\ConditionalBorrowChain.move:71:25+9
    assume {:print "$at(3,2252,2261)"} true;
    $t4 := $ChildMutation($t0, 0, $Dereference($t0)->$v0);

    // trace_return[0]($t4) at .\sources\ConditionalBorrowChain.move:71:9+46
    $temp_0'u64' := $Dereference($t4);
    assume {:print "$track_return(4,4,0):", $temp_0'u64'} $temp_0'u64' == $temp_0'u64';

    // trace_local[n]($t0) at .\sources\ConditionalBorrowChain.move:71:9+46
    $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1' := $Dereference($t0);
    assume {:print "$track_local(4,4,0):", $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1'} $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1' == $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1';
    ...
    // $t5 := move($t4) at .\sources\ConditionalBorrowChain.move:71:9+46
    $t5 := $t4;

    // goto L2 at .\sources\ConditionalBorrowChain.move:71:9+46
    goto L2;

    // label L0 at .\sources\ConditionalBorrowChain.move:71:44+9
L0:

    // $t6 := borrow_field<0xbc::ProphecyBenchmark3Levels2Fields::Node1>.v1($t0) at .\sources\ConditionalBorrowChain.move:71:44+9
    assume {:print "$at(3,2271,2280)"} true;
    $t6 := $ChildMutation($t0, 1, $Dereference($t0)->$v1);

    // trace_return[0]($t6) at .\sources\ConditionalBorrowChain.move:71:9+46
    ...
    // $t5 := move($t6) at .\sources\ConditionalBorrowChain.move:71:9+46
    $t5 := $t6;

    // label L2 at .\sources\ConditionalBorrowChain.move:72:5+1
    assume {:print "$at(3,2287,2288)"} true;
L2:

    // return $t5 at .\sources\ConditionalBorrowChain.move:72:5+1
    assume {:print "$at(3,2287,2288)"} true;
    $ret0 := $t5;
    $ret1 := $t0;
    return;
...
// fun ProphecyBenchmark3Levels2Fields::select_n1 [baseline] at .\sources\ConditionalBorrowChain.move:61:5+113
procedure {:inline 1} $bc_ProphecyBenchmark3Levels2Fields_select_n1(_$t0: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node2), _$t1: int) returns ($ret0: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node1), $ret1: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node2))
{
    // declare local variables
    var $t2: int;
    var $t3: bool;
    var $t4: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node1);
    var $t5: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node1);
    var $t6: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node1);
    var $t0: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node2);
    var $t1: int;
    var $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1': $bc_ProphecyBenchmark3Levels2Fields_Node1;
    var $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2': $bc_ProphecyBenchmark3Levels2Fields_Node2;
    var $temp_0'u64': int;
    ...
    // bytecode translation starts here
    // trace_local[n]($t0) at .\sources\ConditionalBorrowChain.move:61:5+1
    assume {:print "$at(3,1910,1911)"} true;
    $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2' := $Dereference($t0);
    assume {:print "$track_local(4,5,0):", $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2'} $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2' == $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2';

    // trace_local[idx]($t1) at .\sources\ConditionalBorrowChain.move:61:5+1
    assume {:print "$track_local(4,5,1):", $t1} $t1 == $t1;

    // $t2 := 0 at .\sources\ConditionalBorrowChain.move:62:20+1
    assume {:print "$at(3,1982,1983)"} true;
    $t2 := 0;
    assume $IsValid'u64'($t2);

    // $t3 := ==($t1, $t2) at .\sources\ConditionalBorrowChain.move:62:13+8
    $t3 := $IsEqual'u64'($t1, $t2);

    // if ($t3) goto L1 else goto L0 at .\sources\ConditionalBorrowChain.move:62:9+46
    if ($t3) { goto L1; } else { goto L0; }

    // label L1 at .\sources\ConditionalBorrowChain.move:62:25+9
L1:

    // $t4 := borrow_field<0xbc::ProphecyBenchmark3Levels2Fields::Node2>.v0($t0) at .\sources\ConditionalBorrowChain.move:62:25+9
    assume {:print "$at(3,1987,1996)"} true;
    $t4 := $ChildMutation($t0, 0, $Dereference($t0)->$v0);

    // trace_return[0]($t4) at .\sources\ConditionalBorrowChain.move:62:9+46
    $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1' := $Dereference($t4);
    assume {:print "$track_return(4,5,0):", $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1'} $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1' == $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1';

    // trace_local[n]($t0) at .\sources\ConditionalBorrowChain.move:62:9+46
    $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2' := $Dereference($t0);
    assume {:print "$track_local(4,5,0):", $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2'} $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2' == $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2';
    ...
    // $t5 := move($t4) at .\sources\ConditionalBorrowChain.move:62:9+46
    $t5 := $t4;

    // goto L2 at .\sources\ConditionalBorrowChain.move:62:9+46
    goto L2;

    // label L0 at .\sources\ConditionalBorrowChain.move:62:44+9
L0:

    // $t6 := borrow_field<0xbc::ProphecyBenchmark3Levels2Fields::Node2>.v1($t0) at .\sources\ConditionalBorrowChain.move:62:44+9
    assume {:print "$at(3,2006,2015)"} true;
    $t6 := $ChildMutation($t0, 1, $Dereference($t0)->$v1);

    // trace_return[0]($t6) at .\sources\ConditionalBorrowChain.move:62:9+46
    $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1' := $Dereference($t6);
    assume {:print "$track_return(4,5,0):", $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1'} $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1' == $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node1';
    ...
    // $t5 := move($t6) at .\sources\ConditionalBorrowChain.move:62:9+46
    $t5 := $t6;

    // label L2 at .\sources\ConditionalBorrowChain.move:63:5+1
    assume {:print "$at(3,2022,2023)"} true;
L2:

    // return $t5 at .\sources\ConditionalBorrowChain.move:63:5+1
    assume {:print "$at(3,2022,2023)"} true;
    $ret0 := $t5;
    $ret1 := $t0;
    return;
...
// fun ProphecyBenchmark3Levels2Fields::select_n2 [baseline] at .\sources\ConditionalBorrowChain.move:52:5+113
procedure {:inline 1} $bc_ProphecyBenchmark3Levels2Fields_select_n2(_$t0: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node3), _$t1: int) returns ($ret0: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node2), $ret1: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node3))
{
    // declare local variables
    var $t2: int;
    var $t3: bool;
    var $t4: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node2);
    var $t5: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node2);
    var $t6: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node2);
    var $t0: $Mutation ($bc_ProphecyBenchmark3Levels2Fields_Node3);
    var $t1: int;
    var $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2': $bc_ProphecyBenchmark3Levels2Fields_Node2;
    var $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node3': $bc_ProphecyBenchmark3Levels2Fields_Node3;
    var $temp_0'u64': int;
    ...
    $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node3' := $Dereference($t0);
    assume {:print "$track_local(4,6,0):", $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node3'} $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node3' == $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node3';
    ...
    // if ($t3) goto L1 else goto L0 at .\sources\ConditionalBorrowChain.move:53:9+46
    if ($t3) { goto L1; } else { goto L0; }

    // label L1 at .\sources\ConditionalBorrowChain.move:53:25+9
L1:

    // $t4 := borrow_field<0xbc::ProphecyBenchmark3Levels2Fields::Node3>.v0($t0) at .\sources\ConditionalBorrowChain.move:53:25+9
    assume {:print "$at(3,1729,1738)"} true;
    $t4 := $ChildMutation($t0, 0, $Dereference($t0)->$v0);

    // trace_return[0]($t4) at .\sources\ConditionalBorrowChain.move:53:9+46
    $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2' := $Dereference($t4);
    assume {:print "$track_return(4,6,0):", $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2'} $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2' == $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2';

    // trace_local[n]($t0) at .\sources\ConditionalBorrowChain.move:53:9+46
    $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node3' := $Dereference($t0);
    assume {:print "$track_local(4,6,0):", $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node3'} $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node3' == $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node3';
    ...
    // $t5 := move($t4) at .\sources\ConditionalBorrowChain.move:53:9+46
    $t5 := $t4;

    // goto L2 at .\sources\ConditionalBorrowChain.move:53:9+46
    goto L2;

    // label L0 at .\sources\ConditionalBorrowChain.move:53:44+9
L0:

    // $t6 := borrow_field<0xbc::ProphecyBenchmark3Levels2Fields::Node3>.v1($t0) at .\sources\ConditionalBorrowChain.move:53:44+9
    assume {:print "$at(3,1748,1757)"} true;
    $t6 := $ChildMutation($t0, 1, $Dereference($t0)->$v1);

    // trace_return[0]($t6) at .\sources\ConditionalBorrowChain.move:53:9+46
    $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2' := $Dereference($t6);
    assume {:print "$track_return(4,6,0):", $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2'} $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2' == $temp_0'$bc_ProphecyBenchmark3Levels2Fields_Node2';
    ...
    // $t5 := move($t6) at .\sources\ConditionalBorrowChain.move:53:9+46
    $t5 := $t6;

    // label L2 at .\sources\ConditionalBorrowChain.move:54:5+1
    assume {:print "$at(3,1764,1765)"} true;
L2:

    // return $t5 at .\sources\ConditionalBorrowChain.move:54:5+1
    assume {:print "$at(3,1764,1765)"} true;
    $ret0 := $t5;
    $ret1 := $t0;
    return;
