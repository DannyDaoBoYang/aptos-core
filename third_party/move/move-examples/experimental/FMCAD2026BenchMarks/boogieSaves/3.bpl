...
procedure {:timeLimit 40} $bc_ProphecyBenchmark3Levels3Fields_benchmark_from_scratch$verify(_$t0: int, _$t1: int, _$t2: int) returns ($ret0: $bc_ProphecyBenchmark3Levels3Fields_Node3)
{
    ...
    var $t17: int;
    var $t18: int;
    var $t19: $bc_ProphecyBenchmark3Levels3Fields_Node3;
    var $t0: int;
    var $t1: int;
    var $t2: int;
    ...
    // $t3 := ProphecyBenchmark3Levels3Fields::new_node3() on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:88:20+11
    ...
    // $t7 := %($t0, $t6) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:90:20+6
    call $t7 := $Mod($t0, $t6);
    if ($abort_flag) {
    ...
    // $t9 := %($t1, $t8) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:91:20+6
    call $t9 := $Mod($t1, $t8);
    if ($abort_flag) {
    ...
    // $t11 := %($t2, $t10) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:92:20+6
    call $t11 := $Mod($t2, $t10);
    if ($abort_flag) {
    ...
    // $t13 := ProphecyBenchmark3Levels3Fields::select_n2($t12, $t7) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:97:22+23
    ...
    // fulfilled($t12) at .\sources\ConditionalBorrowChain.move:97:22+23
    assume $Fulfilled($t12, $cur_index);

    // $t14 := ProphecyBenchmark3Levels3Fields::select_n1($t13, $t9) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:98:22+23
    ...
    // fulfilled($t13) at .\sources\ConditionalBorrowChain.move:98:22+23
    assume $Fulfilled($t13, $cur_index);

    // $t15 := ProphecyBenchmark3Levels3Fields::select_leaf($t14, $t11) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:99:24+25
    ...
    // fulfilled($t14) at .\sources\ConditionalBorrowChain.move:99:24+25
    ...
    // $t18 := +($t16, $t17) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:100:21+13
...
L1:
    ...
    assume {:print "$at(3,3755,3784)"} true;
    assert {:msg "assert_failed(3,3755,3784): post-condition does not hold"}
      ($t19->$v0->$v0->$v0 <= 1);

    // return $t19 at .\sources\ConditionalBorrowChain.move:127:9+29
    $ret0 := $t19;
    return;

    // label L2 at .\sources\ConditionalBorrowChain.move:103:5+1
    assume {:print "$at(3,3145,3146)"} true;
L2:
...
L1:
    ...
    call $t5 := $ChildMutationAlt($t0, 0, $Dereference($t0)->$v0);
    assume $Dereference($t5) == $Dereference($t0)->$v0;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels3Fields_Node1'_v0($Dereference($t0), $DereferenceProphecy($t5)));
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:73:9+87
    ...
    // goto L5 at .\sources\ConditionalBorrowChain.move:73:9+87
    goto L5;
...
L3:
    ...
    call $t9 := $ChildMutationAlt($t0, 1, $Dereference($t0)->$v1);
    assume $Dereference($t9) == $Dereference($t0)->$v1;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels3Fields_Node1'_v1($Dereference($t0), $DereferenceProphecy($t9)));
    ...
    assume {:print "$track_local(4,4,2):", $temp_0'u64'} $temp_0'u64' == $temp_0'u64';

    // fulfilled($t9) at .\sources\ConditionalBorrowChain.move:73:58+9
    assume $Fulfilled($t9, $cur_index);
...
L2:
    ...
    assume {:print "$at(3,2394,2403)"} true;
    call $t10 := $ChildMutationAlt($t0, 2, $Dereference($t0)->$v2);
    assume $Dereference($t10) == $Dereference($t0)->$v2;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels3Fields_Node1'_v2($Dereference($t0), $DereferenceProphecy($t10)));
    ...
    // fulfilled($t10) at .\sources\ConditionalBorrowChain.move:74:16+9
    assume $Fulfilled($t10, $cur_index);

    // goto L4 at .\sources\ConditionalBorrowChain.move:74:16+9
    goto L4;

    // label L5 at .\sources\ConditionalBorrowChain.move:75:5+1
...
L1:
    ...
    call $t5 := $ChildMutationAlt($t0, 0, $Dereference($t0)->$v0);
    assume $Dereference($t5) == $Dereference($t0)->$v0;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels3Fields_Node2'_v0($Dereference($t0), $DereferenceProphecy($t5)));
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:63:9+87
    assume $Fulfilled($t0, $cur_index);
    ...
    // goto L5 at .\sources\ConditionalBorrowChain.move:63:9+87
    goto L5;
...
L3:
    ...
    call $t9 := $ChildMutationAlt($t0, 1, $Dereference($t0)->$v1);
    assume $Dereference($t9) == $Dereference($t0)->$v1;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels3Fields_Node2'_v1($Dereference($t0), $DereferenceProphecy($t9)));
    ...
    assume {:print "$track_local(4,5,2):", $temp_0'$bc_ProphecyBenchmark3Levels3Fields_Node1'} $temp_0'$bc_ProphecyBenchmark3Levels3Fields_Node1' == $temp_0'$bc_ProphecyBenchmark3Levels3Fields_Node1';

    // fulfilled($t9) at .\sources\ConditionalBorrowChain.move:63:58+9
    assume $Fulfilled($t9, $cur_index);
...
L2:
    ...
    call $t10 := $ChildMutationAlt($t0, 2, $Dereference($t0)->$v2);
    assume $Dereference($t10) == $Dereference($t0)->$v2;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels3Fields_Node2'_v2($Dereference($t0), $DereferenceProphecy($t10)));
    ...
    // fulfilled($t10) at .\sources\ConditionalBorrowChain.move:64:16+9
    assume $Fulfilled($t10, $cur_index);

    // goto L4 at .\sources\ConditionalBorrowChain.move:64:16+9
    goto L4;

    // label L5 at .\sources\ConditionalBorrowChain.move:65:5+1
...
L1:
    ...
    call $t5 := $ChildMutationAlt($t0, 0, $Dereference($t0)->$v0);
    assume $Dereference($t5) == $Dereference($t0)->$v0;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels3Fields_Node3'_v0($Dereference($t0), $DereferenceProphecy($t5)));
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:53:9+87
    assume $Fulfilled($t0, $cur_index);
    ...
    // goto L5 at .\sources\ConditionalBorrowChain.move:53:9+87
    goto L5;
...
L3:
    ...
    call $t9 := $ChildMutationAlt($t0, 1, $Dereference($t0)->$v1);
    assume $Dereference($t9) == $Dereference($t0)->$v1;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels3Fields_Node3'_v1($Dereference($t0), $DereferenceProphecy($t9)));
    ...
    assume {:print "$track_local(4,6,2):", $temp_0'$bc_ProphecyBenchmark3Levels3Fields_Node2'} $temp_0'$bc_ProphecyBenchmark3Levels3Fields_Node2' == $temp_0'$bc_ProphecyBenchmark3Levels3Fields_Node2';

    // fulfilled($t9) at .\sources\ConditionalBorrowChain.move:53:58+9
    assume $Fulfilled($t9, $cur_index);
...
L2:
    ...
    call $t10 := $ChildMutationAlt($t0, 2, $Dereference($t0)->$v2);
    assume $Dereference($t10) == $Dereference($t0)->$v2;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels3Fields_Node3'_v2($Dereference($t0), $DereferenceProphecy($t10)));
    ...
    // fulfilled($t10) at .\sources\ConditionalBorrowChain.move:54:16+9
    assume $Fulfilled($t10, $cur_index);

    // goto L4 at .\sources\ConditionalBorrowChain.move:54:16+9
    goto L4;

    // label L5 at .\sources\ConditionalBorrowChain.move:55:5+1
