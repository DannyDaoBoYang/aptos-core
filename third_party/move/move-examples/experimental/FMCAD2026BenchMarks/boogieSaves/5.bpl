...
procedure {:timeLimit 40} $bc_ProphecyBenchmark3Levels5Fields_benchmark_from_scratch$verify(_$t0: int, _$t1: int, _$t2: int) returns ($ret0: $bc_ProphecyBenchmark3Levels5Fields_Node3)
{
    ...
    var $t17: int;
    var $t18: int;
    var $t19: $bc_ProphecyBenchmark3Levels5Fields_Node3;
    var $t0: int;
    var $t1: int;
    var $t2: int;
    ...
    // $t3 := ProphecyBenchmark3Levels5Fields::new_node3() on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:91:20+11
    ...
    // $t7 := %($t0, $t6) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:93:20+6
    call $t7 := $Mod($t0, $t6);
    if ($abort_flag) {
    ...
    // $t9 := %($t1, $t8) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:94:20+6
    call $t9 := $Mod($t1, $t8);
    if ($abort_flag) {
    ...
    // $t11 := %($t2, $t10) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:95:20+6
    call $t11 := $Mod($t2, $t10);
    if ($abort_flag) {
    ...
    // $t13 := ProphecyBenchmark3Levels5Fields::select_n2($t12, $t7) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:100:22+23
    ...
    // fulfilled($t12) at .\sources\ConditionalBorrowChain.move:100:22+23
    assume $Fulfilled($t12, $cur_index);

    // $t14 := ProphecyBenchmark3Levels5Fields::select_n1($t13, $t9) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:101:22+23
    ...
    // fulfilled($t13) at .\sources\ConditionalBorrowChain.move:101:22+23
    assume $Fulfilled($t13, $cur_index);

    // $t15 := ProphecyBenchmark3Levels5Fields::select_leaf($t14, $t11) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:102:24+25
    ...
    // fulfilled($t14) at .\sources\ConditionalBorrowChain.move:102:24+25
    ...
    // $t18 := +($t16, $t17) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:103:21+13
    ...
    assume $IsEqual'$bc_ProphecyBenchmark3Levels5Fields_Node3'($Dereference($t12), $DereferenceProphecy($t12));

    // trace_local[root]($t3) at .\sources\ConditionalBorrowChain.move:103:9+25
    assume {:print "$track_local(4,0,3):", $t3} $t3 == $t3;

    // $t19 := move($t3) at .\sources\ConditionalBorrowChain.move:105:9+4
    assume {:print "$at(3,3358,3362)"} true;
    $t19 := $t3;

    // trace_return[0]($t19) at .\sources\ConditionalBorrowChain.move:90:14+418
    assume {:print "$at(3,2950,3368)"} true;
    assume {:print "$track_return(4,0,0):", $t19} $t19 == $t19;

    // label L1 at .\sources\ConditionalBorrowChain.move:106:5+1
    assume {:print "$at(3,3367,3368)"} true;
L1:

    // assert Implies(And(And(Eq<u64>($t0, 0), Eq<u64>($t1, 0)), Eq<u64>($t2, 0)), Eq<u64>(select ProphecyBenchmark3Levels5Fields::Node1.v0<0xbc::ProphecyBenchmark3Levels5Fields::Node1>(select ProphecyBenchmark3Levels5Fields::Node2.v0<0xbc::ProphecyBenchmark3Levels5Fields::Node2>(select ProphecyBenchmark3Levels5Fields::Node3.v0<0xbc::ProphecyBenchmark3Levels5Fields::Node3>($t19))), 1)) at .\sources\ConditionalBorrowChain.move:122:9+72
    ...
    // assert Implies(Or(Or(Neq<num>(Mod($t0, 8), 0), Neq<num>(Mod($t1, 8), 0)), Neq<num>(Mod($t2, 8), 0)), Eq<u64>(select ProphecyBenchmark3Levels5Fields::Node1.v0<0xbc::ProphecyBenchmark3Levels5Fields::Node1>(select ProphecyBenchmark3Levels5Fields::Node2.v0<0xbc::ProphecyBenchmark3Levels5Fields::Node2>(select ProphecyBenchmark3Levels5Fields::Node3.v0<0xbc::ProphecyBenchmark3Levels5Fields::Node3>($t19))), 0)) at .\sources\ConditionalBorrowChain.move:126:9+78
    assume {:print "$at(3,3851,3929)"} true;
    assert {:msg "assert_failed(3,3851,3929): post-condition does not hold"}
      (((!$IsEqual'num'(($t0 mod 8), 0) || !$IsEqual'num'(($t1 mod 8), 0)) || !$IsEqual'num'(($t2 mod 8), 0)) ==> $IsEqual'u64'($t19->$v0->$v0->$v0, 0));
    ...
    // return $t19 at .\sources\ConditionalBorrowChain.move:130:9+29
    $ret0 := $t19;
    return;

    // label L2 at .\sources\ConditionalBorrowChain.move:106:5+1
    assume {:print "$at(3,3367,3368)"} true;
L2:
...
L1:
    ...
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node1'_v0($Dereference($t0), $DereferenceProphecy($t4)));
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:75:9+161
...
L3:
    ...
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node1'_v1($Dereference($t0), $DereferenceProphecy($t8)));
...
L5:
    ...
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node1'_v2($Dereference($t0), $DereferenceProphecy($t11)));
...
L7:
    ...
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node1'_v3($Dereference($t0), $DereferenceProphecy($t14)));
...
L6:
    ...
    assume {:print "$at(3,2616,2625)"} true;
    call $t15 := $ChildMutationAlt($t0, 4, $Dereference($t0)->$v4);
    assume $Dereference($t15) == $Dereference($t0)->$v4;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node1'_v4($Dereference($t0), $DereferenceProphecy($t15)));
...
L1:
    ...
    call $t4 := $ChildMutationAlt($t0, 0, $Dereference($t0)->$v0);
    assume $Dereference($t4) == $Dereference($t0)->$v0;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node2'_v0($Dereference($t0), $DereferenceProphecy($t4)));
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:64:9+161
    assume $Fulfilled($t0, $cur_index);
...
L3:
    ...
    call $t8 := $ChildMutationAlt($t0, 1, $Dereference($t0)->$v1);
    assume $Dereference($t8) == $Dereference($t0)->$v1;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node2'_v1($Dereference($t0), $DereferenceProphecy($t8)));
...
L5:
    ...
    call $t11 := $ChildMutationAlt($t0, 2, $Dereference($t0)->$v2);
    assume $Dereference($t11) == $Dereference($t0)->$v2;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node2'_v2($Dereference($t0), $DereferenceProphecy($t11)));
...
L7:
    ...
    call $t14 := $ChildMutationAlt($t0, 3, $Dereference($t0)->$v3);
    assume $Dereference($t14) == $Dereference($t0)->$v3;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node2'_v3($Dereference($t0), $DereferenceProphecy($t14)));
...
L6:
    ...
    call $t15 := $ChildMutationAlt($t0, 4, $Dereference($t0)->$v4);
    assume $Dereference($t15) == $Dereference($t0)->$v4;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node2'_v4($Dereference($t0), $DereferenceProphecy($t15)));
...
L1:
    ...
    call $t4 := $ChildMutationAlt($t0, 0, $Dereference($t0)->$v0);
    assume $Dereference($t4) == $Dereference($t0)->$v0;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node3'_v0($Dereference($t0), $DereferenceProphecy($t4)));
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:53:9+161
    assume $Fulfilled($t0, $cur_index);
...
L3:
    ...
    call $t8 := $ChildMutationAlt($t0, 1, $Dereference($t0)->$v1);
    assume $Dereference($t8) == $Dereference($t0)->$v1;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node3'_v1($Dereference($t0), $DereferenceProphecy($t8)));
...
L5:
    ...
    call $t11 := $ChildMutationAlt($t0, 2, $Dereference($t0)->$v2);
    assume $Dereference($t11) == $Dereference($t0)->$v2;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node3'_v2($Dereference($t0), $DereferenceProphecy($t11)));
...
L7:
    ...
    call $t14 := $ChildMutationAlt($t0, 3, $Dereference($t0)->$v3);
    assume $Dereference($t14) == $Dereference($t0)->$v3;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node3'_v3($Dereference($t0), $DereferenceProphecy($t14)));
...
L6:
    ...
    call $t15 := $ChildMutationAlt($t0, 4, $Dereference($t0)->$v4);
    assume $Dereference($t15) == $Dereference($t0)->$v4;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels5Fields_Node3'_v4($Dereference($t0), $DereferenceProphecy($t15)));
