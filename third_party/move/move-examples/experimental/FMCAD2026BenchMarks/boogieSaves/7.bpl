...
L1:
    ...
    assume {:print "$at(3,4186,4215)"} true;
    assert {:msg "assert_failed(3,4186,4215): post-condition does not hold"}
      ($t19->$v0->$v0->$v0 <= 1);
...
L1:
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:77:9+235
...
L10:
    ...
    assume {:print "$at(3,2820,2829)"} true;
    call $t21 := $ChildMutationAlt($t0, 6, $Dereference($t0)->$v6);
    assume $Dereference($t21) == $Dereference($t0)->$v6;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels_Node1'_v6($Dereference($t0), $DereferenceProphecy($t21)));
...
L1:
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:65:9+235
    assume $Fulfilled($t0, $cur_index);
...
L10:
    ...
    call $t21 := $ChildMutationAlt($t0, 6, $Dereference($t0)->$v6);
    assume $Dereference($t21) == $Dereference($t0)->$v6;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels_Node2'_v6($Dereference($t0), $DereferenceProphecy($t21)));
...
L1:
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:53:9+235
    assume $Fulfilled($t0, $cur_index);
...
L10:
    ...
    call $t21 := $ChildMutationAlt($t0, 6, $Dereference($t0)->$v6);
    assume $Dereference($t21) == $Dereference($t0)->$v6;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels_Node3'_v6($Dereference($t0), $DereferenceProphecy($t21)));
