...
procedure {:timeLimit 40} $bc_ProphecyBenchmark3Levels4Fields_benchmark_from_scratch$verify(_$t0: int, _$t1: int, _$t2: int) returns ($ret0: $bc_ProphecyBenchmark3Levels4Fields_Node3)
{
    ...
    var $t17: int;
    var $t18: int;
    var $t19: $bc_ProphecyBenchmark3Levels4Fields_Node3;
    var $t0: int;
    var $t1: int;
    var $t2: int;
    ...
    // $t3 := ProphecyBenchmark3Levels4Fields::new_node3() on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:88:20+11
    ...
    // $t13 := ProphecyBenchmark3Levels4Fields::select_n2($t12, $t7) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:97:22+23
    ...
    // $t14 := ProphecyBenchmark3Levels4Fields::select_n1($t13, $t9) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:98:22+23
    ...
    // $t15 := ProphecyBenchmark3Levels4Fields::select_leaf($t14, $t11) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:99:24+25
    ...
    assume $IsEqual'$bc_ProphecyBenchmark3Levels4Fields_Node3'($Dereference($t12), $DereferenceProphecy($t12));
...
L1:
    ...
    // assert Implies(Or(Or(Neq<num>(Mod($t0, 8), 0), Neq<num>(Mod($t1, 8), 0)), Neq<num>(Mod($t2, 8), 0)), Eq<u64>(select ProphecyBenchmark3Levels4Fields::Node1.v0<0xbc::ProphecyBenchmark3Levels4Fields::Node1>(select ProphecyBenchmark3Levels4Fields::Node2.v0<0xbc::ProphecyBenchmark3Levels4Fields::Node2>(select ProphecyBenchmark3Levels4Fields::Node3.v0<0xbc::ProphecyBenchmark3Levels4Fields::Node3>($t19))), 0)) at .\sources\ConditionalBorrowChain.move:123:9+78
    assume {:print "$at(3,3728,3806)"} true;
    assert {:msg "assert_failed(3,3728,3806): post-condition does not hold"}
    ...
    assume {:print "$at(3,3854,3883)"} true;
    assert {:msg "assert_failed(3,3854,3883): post-condition does not hold"}
      ($t19->$v0->$v0->$v0 <= 1);
...
procedure {:inline 1} $bc_ProphecyBenchmark3Levels4Fields_select_leaf(_$t0: $Mutation ($bc_ProphecyBenchmark3Levels4Fields_Node1), _$t1: int) returns ($ret0: $Mutation (int), $ret1: $Mutation ($bc_ProphecyBenchmark3Levels4Fields_Node1))
{
    ...
    assume {:print "$track_local(4,4,0):", $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node1'} $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node1' == $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node1';
...
L1:
    ...
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels4Fields_Node1'_v0($Dereference($t0), $DereferenceProphecy($t4)));
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:73:9+120
...
L3:
    ...
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels4Fields_Node1'_v1($Dereference($t0), $DereferenceProphecy($t8)));
...
L5:
    ...
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels4Fields_Node1'_v2($Dereference($t0), $DereferenceProphecy($t11)));
...
L4:
    ...
    assume {:print "$at(3,2493,2502)"} true;
    call $t12 := $ChildMutationAlt($t0, 3, $Dereference($t0)->$v3);
    assume $Dereference($t12) == $Dereference($t0)->$v3;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels4Fields_Node1'_v3($Dereference($t0), $DereferenceProphecy($t12)));
...
procedure {:inline 1} $bc_ProphecyBenchmark3Levels4Fields_select_n1(_$t0: $Mutation ($bc_ProphecyBenchmark3Levels4Fields_Node2), _$t1: int) returns ($ret0: $Mutation ($bc_ProphecyBenchmark3Levels4Fields_Node1), $ret1: $Mutation ($bc_ProphecyBenchmark3Levels4Fields_Node2))
{
    ...
    assume {:print "$track_local(4,5,0):", $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node2'} $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node2' == $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node2';
...
L1:
    ...
    call $t4 := $ChildMutationAlt($t0, 0, $Dereference($t0)->$v0);
    assume $Dereference($t4) == $Dereference($t0)->$v0;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels4Fields_Node2'_v0($Dereference($t0), $DereferenceProphecy($t4)));
    ...
    assume {:print "$track_return(4,5,0):", $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node1'} $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node1' == $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node1';

    // trace_local[n]($t0) at .\sources\ConditionalBorrowChain.move:63:9+120
    $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node2' := $Dereference($t0);
    assume {:print "$track_local(4,5,0):", $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node2'} $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node2' == $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node2';

    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:63:9+120
    assume $Fulfilled($t0, $cur_index);
...
L3:
    ...
    call $t8 := $ChildMutationAlt($t0, 1, $Dereference($t0)->$v1);
    assume $Dereference($t8) == $Dereference($t0)->$v1;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels4Fields_Node2'_v1($Dereference($t0), $DereferenceProphecy($t8)));
...
L5:
    ...
    call $t11 := $ChildMutationAlt($t0, 2, $Dereference($t0)->$v2);
    assume $Dereference($t11) == $Dereference($t0)->$v2;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels4Fields_Node2'_v2($Dereference($t0), $DereferenceProphecy($t11)));
...
L4:
    ...
    call $t12 := $ChildMutationAlt($t0, 3, $Dereference($t0)->$v3);
    assume $Dereference($t12) == $Dereference($t0)->$v3;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels4Fields_Node2'_v3($Dereference($t0), $DereferenceProphecy($t12)));
...
procedure {:inline 1} $bc_ProphecyBenchmark3Levels4Fields_select_n2(_$t0: $Mutation ($bc_ProphecyBenchmark3Levels4Fields_Node3), _$t1: int) returns ($ret0: $Mutation ($bc_ProphecyBenchmark3Levels4Fields_Node2), $ret1: $Mutation ($bc_ProphecyBenchmark3Levels4Fields_Node3))
{
    ...
    assume {:print "$track_local(4,6,0):", $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node3'} $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node3' == $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node3';
...
L1:
    ...
    call $t4 := $ChildMutationAlt($t0, 0, $Dereference($t0)->$v0);
    assume $Dereference($t4) == $Dereference($t0)->$v0;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels4Fields_Node3'_v0($Dereference($t0), $DereferenceProphecy($t4)));
    ...
    assume {:print "$track_return(4,6,0):", $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node2'} $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node2' == $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node2';

    // trace_local[n]($t0) at .\sources\ConditionalBorrowChain.move:53:9+120
    $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node3' := $Dereference($t0);
    assume {:print "$track_local(4,6,0):", $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node3'} $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node3' == $temp_0'$bc_ProphecyBenchmark3Levels4Fields_Node3';

    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:53:9+120
    assume $Fulfilled($t0, $cur_index);
...
L3:
    ...
    call $t8 := $ChildMutationAlt($t0, 1, $Dereference($t0)->$v1);
    assume $Dereference($t8) == $Dereference($t0)->$v1;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels4Fields_Node3'_v1($Dereference($t0), $DereferenceProphecy($t8)));
...
L5:
    ...
    call $t11 := $ChildMutationAlt($t0, 2, $Dereference($t0)->$v2);
    assume $Dereference($t11) == $Dereference($t0)->$v2;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels4Fields_Node3'_v2($Dereference($t0), $DereferenceProphecy($t11)));
...
L4:
    ...
    call $t12 := $ChildMutationAlt($t0, 3, $Dereference($t0)->$v3);
    assume $Dereference($t12) == $Dereference($t0)->$v3;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels4Fields_Node3'_v3($Dereference($t0), $DereferenceProphecy($t12)));
