...
procedure {:timeLimit 40} $bc_ProphecyBenchmark3Levels_benchmark_from_scratch$verify(_$t0: int, _$t1: int, _$t2: int) returns ($ret0: $bc_ProphecyBenchmark3Levels_Node3)
{
    ...
    // $t3 := ProphecyBenchmark3Levels::new_node3() on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:91:20+11
    ...
    // $t13 := ProphecyBenchmark3Levels::select_n2($t12, $t7) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:100:22+23
    ...
    // $t14 := ProphecyBenchmark3Levels::select_n1($t13, $t9) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:101:22+23
    ...
    // $t15 := ProphecyBenchmark3Levels::select_leaf($t14, $t11) on_abort goto L2 with $t5 at .\sources\ConditionalBorrowChain.move:102:24+25
...
L1:
    ...
    // assert Implies(Or(Or(Neq<num>(Mod($t0, 8), 0), Neq<num>(Mod($t1, 8), 0)), Neq<num>(Mod($t2, 8), 0)), Eq<u64>(select ProphecyBenchmark3Levels::Node1.v0<0xbc::ProphecyBenchmark3Levels::Node1>(select ProphecyBenchmark3Levels::Node2.v0<0xbc::ProphecyBenchmark3Levels::Node2>(select ProphecyBenchmark3Levels::Node3.v0<0xbc::ProphecyBenchmark3Levels::Node3>($t19))), 0)) at .\sources\ConditionalBorrowChain.move:126:9+78
    ...
    // assert Le(select ProphecyBenchmark3Levels::Node1.v0<0xbc::ProphecyBenchmark3Levels::Node1>(select ProphecyBenchmark3Levels::Node2.v0<0xbc::ProphecyBenchmark3Levels::Node2>(select ProphecyBenchmark3Levels::Node3.v0<0xbc::ProphecyBenchmark3Levels::Node3>($t19))), 1) at .\sources\ConditionalBorrowChain.move:130:9+29
...
L1:
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:75:9+194
...
L8:
    ...
    assume {:print "$at(3,2697,2706)"} true;
    call $t18 := $ChildMutationAlt($t0, 7, $Dereference($t0)->$v7);
    assume $Dereference($t18) == $Dereference($t0)->$v7;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels_Node1'_v7($Dereference($t0), $DereferenceProphecy($t18)));
...
L1:
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:64:9+194
    assume $Fulfilled($t0, $cur_index);
...
L8:
    ...
    call $t18 := $ChildMutationAlt($t0, 7, $Dereference($t0)->$v7);
    assume $Dereference($t18) == $Dereference($t0)->$v7;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels_Node2'_v7($Dereference($t0), $DereferenceProphecy($t18)));
...
L1:
    ...
    // fulfilled($t0) at .\sources\ConditionalBorrowChain.move:53:9+194
    assume $Fulfilled($t0, $cur_index);
...
L8:
    ...
    call $t18 := $ChildMutationAlt($t0, 7, $Dereference($t0)->$v7);
    assume $Dereference($t18) == $Dereference($t0)->$v7;
    $t0 := $UpdateMutation($t0, $Update'$bc_ProphecyBenchmark3Levels_Node3'_v7($Dereference($t0), $DereferenceProphecy($t18)));
