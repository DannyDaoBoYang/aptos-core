...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((L2_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (> (+ $t5 $t6) 18446744073709551615)))))
...
(let ((anon14_Else_correct  (=> (and (not $abort_flag@3) (= $t11@0 ($Mutation_21031 (|l#$Mutation_21031| call3formal@result@0) (|p#$Mutation_21031| call3formal@result@0) inline$$AddU64$0$dst@2 (|v_final#$Mutation_21031| call3formal@result@0)))) (=> (and (and (= (|v#$Mutation_21031| $t11@0) (|v_final#$Mutation_21031| $t11@0)) (= (|v#$Mutation_60154| $t10@0) (|v_final#$Mutation_60154| $t10@0))) (and (= (|v#$Mutation_60131| $t9@1) (|v_final#$Mutation_60131| $t9@1)) (= $t14 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory@1|) _$t0)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (> (+ $t5 $t6) 18446744073709551615))) (=> (not (> (+ $t5 $t6) 18446744073709551615)) (=> (= (ControlFlow 0 2) (- 0 1)) (= $t14 (+ $t5 $t6)))))))))))
...
(let ((anon13_Else_correct  (=> (not $abort_flag@2) (=> (and (and (= call2formal@v@0 (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_60131| $t9@0))) (= (|v#$Mutation_60154| call3formal@result@0@@0) (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_60131| $t9@0)))) (and (= $t9@1 ($Mutation_60131 (|l#$Mutation_60131| $t9@0) (|p#$Mutation_60131| $t9@0) (|$bc_BasicCoin_Balance'#0'| (|v_final#$Mutation_60154| call3formal@result@0@@0)) (|v_final#$Mutation_60131| $t9@0))) (= (|v#$Mutation_60131| $t9@1) (|v_final#$Mutation_60131| $t9@1)))) (=> (and (and (and (= call2formal@v@0@@0 (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_60154| call3formal@result@0@@0))) (= (|v#$Mutation_21031| call3formal@result@0) (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_60154| call3formal@result@0@@0)))) (and (= $t10@0 ($Mutation_60154 (|l#$Mutation_60154| call3formal@result@0@@0) (|p#$Mutation_60154| call3formal@result@0@@0) (|$bc_BasicCoin_Coin'#0'| (|v_final#$Mutation_21031| call3formal@result@0)) (|v_final#$Mutation_60154| call3formal@result@0@@0))) (= (|v#$Mutation_60154| $t10@0) (|v_final#$Mutation_60154| $t10@0)))) (and (and (= $t12@0 (|$value#$bc_BasicCoin_Coin'#0'| _$t1)) (= $t12@0 $t12@0)) (and (= |$temp_0'u64'@0| (|v#$Mutation_21031| call3formal@result@0)) (= |$temp_0'u64'@0| |$temp_0'u64'@0|)))) (and (=> (= (ControlFlow 0 13) 12) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 13) 10) inline$$AddU64$0$anon3_Else_correct)))))))
...
(let ((anon12_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (= (ControlFlow 0 16) 15)) anon12_Then$1_correct)))
...
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (= (ControlFlow 0 22) 21)) |inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then$1_correct|)))
...
(let ((anon0$1_correct  (=> (and (and (and (|$IsValid'address'| _$t0) (|$IsValid'$bc_BasicCoin_Coin'#0''| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory|) $a_0)))
...
)) (= $t5 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_59461| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)))))) (and (and (= $t6 (|$value#$bc_BasicCoin_Coin'#0'| _$t1)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= (ControlFlow 0 24) 23)))) |inline$$bc_BasicCoin_balance_of'#0'$0$anon0_correct|)))
