...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon8_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t3@0 (|$coin#$bc_BasicCoin_Balance'#0'| $t1@1)) (= $t4@0 (|$value#$bc_BasicCoin_Coin'#0'| $t3@0))) (and (= $t4@0 $t4@0) (= (ControlFlow 0 4) (- 0 3)))) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_58087| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)))))))
(let ((anon8_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 2) (- 0 1))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_58087| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0))))))
...
(let ((anon7_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_58087| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (= (ControlFlow 0 7) 6)) anon7_Then$1_correct)))
(let ((anon7_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_58087| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0) (=> (and (and (= $t1@0 (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_58087| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (= $t1@1 $t1@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 5) 2) anon8_Then_correct) (=> (= (ControlFlow 0 5) 4) anon8_Else_correct))))))
(let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_58087| |$bc_BasicCoin_Balance'#0'_$memory|) $a_0)))
