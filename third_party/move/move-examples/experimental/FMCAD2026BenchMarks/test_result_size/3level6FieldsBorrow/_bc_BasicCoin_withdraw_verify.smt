...
(declare-fun $t10@0 () T@$Mutation_59250)
(declare-fun $t9@1 () T@$Mutation_59227)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((anon20_Else_correct  (=> (not $abort_flag@3) (=> (and (= inline$$SubU64$0$dst@2 inline$$SubU64$0$dst@2) (= |$temp_0'u64'@0| (|v#$Mutation_21031| call3formal@result@0))) (=> (and (and (and (= |$temp_0'u64'@0| |$temp_0'u64'@0|) (= $t11@0 ($Mutation_21031 (|l#$Mutation_21031| call3formal@result@0) (|p#$Mutation_21031| call3formal@result@0) inline$$SubU64$0$dst@2 (|v_final#$Mutation_21031| call3formal@result@0)))) (and (= (|v#$Mutation_21031| $t11@0) (|v_final#$Mutation_21031| $t11@0)) (= (|v#$Mutation_59250| $t10@0) (|v_final#$Mutation_59250| $t10@0)))) (and (and (= (|v#$Mutation_59227| $t9@1) (|v_final#$Mutation_59227| $t9@1)) (= $t13@0 (|$bc_BasicCoin_Coin'#0'| _$t1))) (and (= $t13@0 $t13@0) (= $t15 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory@1|) _$t0))))))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (not (< $t5 _$t1))) (=> (not (< $t5 _$t1)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= $t13@0 (|$bc_BasicCoin_Coin'#0'| _$t1))) (=> (= $t13@0 (|$bc_BasicCoin_Coin'#0'| _$t1)) (=> (= (ControlFlow 0 8) (- 0 7)) (= $t15 (- $t5 _$t1))))))))))))))
(let ((L3_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (< $t5 _$t1)))))
...
(let ((anon19_Else_correct  (=> (not $abort_flag@2) (=> (and (and (and (= call2formal@v@0 (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_59227| $t9@0))) (= (|v#$Mutation_59250| call3formal@result@0@@0) (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_59227| $t9@0)))) (and (= $t9@1 ($Mutation_59227 (|l#$Mutation_59227| $t9@0) (|p#$Mutation_59227| $t9@0) (|$bc_BasicCoin_Balance'#0'| (|v_final#$Mutation_59250| call3formal@result@0@@0)) (|v_final#$Mutation_59227| $t9@0))) (= (|v#$Mutation_59227| $t9@1) (|v_final#$Mutation_59227| $t9@1)))) (and (and (= call2formal@v@0@@0 (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_59250| call3formal@result@0@@0))) (= (|v#$Mutation_21031| call3formal@result@0) (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_59250| call3formal@result@0@@0)))) (and (= $t10@0 ($Mutation_59250 (|l#$Mutation_59250| call3formal@result@0@@0) (|p#$Mutation_59250| call3formal@result@0@@0) (|$bc_BasicCoin_Coin'#0'| (|v_final#$Mutation_21031| call3formal@result@0)) (|v_final#$Mutation_59250| call3formal@result@0@@0))) (= (|v#$Mutation_59250| $t10@0) (|v_final#$Mutation_59250| $t10@0))))) (and (=> (= (ControlFlow 0 15) 14) inline$$SubU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 15) 12) inline$$SubU64$0$anon3_Else_correct))))))
...
(let ((anon18_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (= (ControlFlow 0 18) 17)) anon18_Then$1_correct)))
(let ((anon18_Else_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0) (= call0formal@l@0 ($Global _$t0))) (=> (and (and (and (= call1formal@p@0 (Vec_11028 (MapConstVec_19835 DefaultVecElem_19835) 0)) (= call2formal@v@0@@1 (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0))) (and (= (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0) (|v#$Mutation_59227| call3formal@result@0@@1)) (= |$bc_BasicCoin_Balance'#0'_$memory@0| ($Memory_58557 (|Store__T@[Int]Bool_| (|domain#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0 true) (|Store__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0 (|v_final#$Mutation_59227| call3formal@result@0@@1)))))) (and (and (= |$bc_BasicCoin_Balance'#0'_$memory@1| |$bc_BasicCoin_Balance'#0'_$memory@0|) (= $t9@0 call3formal@result@0@@1)) (and (= $abort_code@2 $abort_code@1) (= $abort_flag@2 $abort_flag@1)))) (and (=> (= (ControlFlow 0 16) 5) anon19_Then_correct) (=> (= (ControlFlow 0 16) 15) anon19_Else_correct))))))
...
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (= (ControlFlow 0 26) 25)) |inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then$1_correct|)))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0) (=> (and (and (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@1| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@2| |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 24) 22) |inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Then_correct|) (=> (= (ControlFlow 0 24) 23) |inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Else_correct|))))))
...
(let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (|$IsValid'u64'| _$t1) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory|) $a_0)))
...
))) (=> (and (and (= $t5 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_58557| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)))) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= (ControlFlow 0 28) 27))) |inline$$bc_BasicCoin_balance_of'#0'$0$anon0_correct|)))))
