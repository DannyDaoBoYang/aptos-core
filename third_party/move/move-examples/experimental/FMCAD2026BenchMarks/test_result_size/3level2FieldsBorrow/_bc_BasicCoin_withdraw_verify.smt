...
(declare-fun $t10@0 () T@$Mutation_57370)
(declare-fun $t9@1 () T@$Mutation_57347)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 31) (let ((anon20_Else_correct  (=> (not $abort_flag@3) (=> (and (= inline$$SubU64$0$dst@2 inline$$SubU64$0$dst@2) (= |$temp_0'u64'@0| (|v#$Mutation_21031| call3formal@result@0))) (=> (and (and (and (= |$temp_0'u64'@0| |$temp_0'u64'@0|) (= $t11@0 ($Mutation_21031 (|l#$Mutation_21031| call3formal@result@0) (|p#$Mutation_21031| call3formal@result@0) inline$$SubU64$0$dst@2 (|v_final#$Mutation_21031| call3formal@result@0)))) (and (= (|v#$Mutation_21031| $t11@0) (|v_final#$Mutation_21031| $t11@0)) (= (|v#$Mutation_57370| $t10@0) (|v_final#$Mutation_57370| $t10@0)))) (and (and (= (|v#$Mutation_57347| $t9@1) (|v_final#$Mutation_57347| $t9@1)) (= $t13@0 (|$bc_BasicCoin_Coin'#0'| _$t1))) (and (= $t13@0 $t13@0) (= $t15 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@1|) _$t0))))))) (and (=> (= (ControlFlow 0 8) (- 0 11)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0))) (and (=> (= (ControlFlow 0 8) (- 0 10)) (not (< $t5 _$t1))) (=> (not (< $t5 _$t1)) (and (=> (= (ControlFlow 0 8) (- 0 9)) (= $t13@0 (|$bc_BasicCoin_Coin'#0'| _$t1))) (=> (= $t13@0 (|$bc_BasicCoin_Coin'#0'| _$t1)) (=> (= (ControlFlow 0 8) (- 0 7)) (= $t15 (- $t5 _$t1))))))))))))))
(let ((L3_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (< $t5 _$t1)))))
...
(let ((anon19_Else_correct  (=> (not $abort_flag@2) (=> (and (and (and (= call2formal@v@0 (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_57347| $t9@0))) (= (|v#$Mutation_57370| call3formal@result@0@@0) (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_57347| $t9@0)))) (and (= $t9@1 ($Mutation_57347 (|l#$Mutation_57347| $t9@0) (|p#$Mutation_57347| $t9@0) (|$bc_BasicCoin_Balance'#0'| (|v_final#$Mutation_57370| call3formal@result@0@@0)) (|v_final#$Mutation_57347| $t9@0))) (= (|v#$Mutation_57347| $t9@1) (|v_final#$Mutation_57347| $t9@1)))) (and (and (= call2formal@v@0@@0 (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_57370| call3formal@result@0@@0))) (= (|v#$Mutation_21031| call3formal@result@0) (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_57370| call3formal@result@0@@0)))) (and (= $t10@0 ($Mutation_57370 (|l#$Mutation_57370| call3formal@result@0@@0) (|p#$Mutation_57370| call3formal@result@0@@0) (|$bc_BasicCoin_Coin'#0'| (|v_final#$Mutation_21031| call3formal@result@0)) (|v_final#$Mutation_57370| call3formal@result@0@@0))) (= (|v#$Mutation_57370| $t10@0) (|v_final#$Mutation_57370| $t10@0))))) (and (=> (= (ControlFlow 0 15) 14) inline$$SubU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 15) 12) inline$$SubU64$0$anon3_Else_correct))))))
...
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (= (ControlFlow 0 26) 25)) |inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then$1_correct|)))
...
))) (=> (and (and (= $t5 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)))) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= (ControlFlow 0 28) 27))) |inline$$bc_BasicCoin_balance_of'#0'$0$anon0_correct|)))))
