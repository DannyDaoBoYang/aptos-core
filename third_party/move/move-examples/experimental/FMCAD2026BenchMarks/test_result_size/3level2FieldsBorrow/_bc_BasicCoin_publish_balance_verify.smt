...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 40) (let ((L3_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))))))
...
(let ((anon19_Else_correct  (=> (and (not $abort_flag@1) (= $t10 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@1|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@1|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0)))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@1|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))) (=> (= (ControlFlow 0 3) (- 0 2)) (= $t10 0)))))))))
...
(let ((anon18_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))) (= (ControlFlow 0 12) 11)) anon18_Then$1_correct)))
(let ((anon18_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0)))) (=> (and (and (= |$bc_BasicCoin_Balance'#0'_$memory@0| ($Memory_56677 (|Store__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0)) true) (|Store__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0)) $t7@0))) (= |$bc_BasicCoin_Balance'#0'_$memory@1| |$bc_BasicCoin_Balance'#0'_$memory@0|)) (and (= $abort_code@1 $abort_code@0) (= $abort_flag@1 $abort_flag@0))) (and (=> (= (ControlFlow 0 10) 9) anon19_Then_correct) (=> (= (ControlFlow 0 10) 3) anon19_Else_correct))))))
...
(let ((anon16_Else_correct  (=> (and (not $abort_flag@0) (= $t6@0 (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1))) (and (=> (= (ControlFlow 0 33) 32) anon17_Then_correct) (=> (= (ControlFlow 0 33) 13) anon17_Else_correct)))))
