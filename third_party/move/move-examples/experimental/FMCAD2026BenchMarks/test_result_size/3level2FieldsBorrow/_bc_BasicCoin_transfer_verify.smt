...
(declare-fun |$bc_BasicCoin_Balance'#0'_$memory@7| () T@$Memory_56677)
(declare-fun $t6 () Int)
(declare-fun $t18 () Int)
...
(declare-fun |$bc_BasicCoin_Balance'#0'_$memory@6| () T@$Memory_56677)
(declare-fun $abort_flag@9 () Bool)
(declare-fun $abort_code@7 () Int)
(declare-fun |$bc_BasicCoin_Balance'#0'_$memory@5| () T@$Memory_56677)
...
(declare-fun |$bc_BasicCoin_Balance'#0'_$memory@4| () T@$Memory_56677)
...
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$t10@1| () T@$Mutation_57370)
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@2| () T@$Mutation_57347)
...
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1| () T@$Mutation_57347)
(declare-fun call3formal@result@0@@3 () T@$Mutation_57370)
(declare-fun call2formal@v@0@@3 () Int)
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@0| () T@$Mutation_57347)
...
(declare-fun call3formal@result@0@@4 () T@$Mutation_57347)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 68) (let ((anon16_Else_correct  (=> (not $abort_flag@10) (=> (and (= $t17 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@7|) $t6)))) (= $t18 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@7|) _$t1))))) (and (=> (= (ControlFlow 0 9) (- 0 15)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) $t6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) $t6))) (and (=> (= (ControlFlow 0 9) (- 0 14)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) _$t1))) (and (=> (= (ControlFlow 0 9) (- 0 13)) (not (< $t7 _$t2))) (=> (not (< $t7 _$t2)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (not (> (+ $t8 _$t2) 18446744073709551615))) (=> (not (> (+ $t8 _$t2) 18446744073709551615)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (not (= $t6 _$t1))) (=> (not (= $t6 _$t1)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= $t17 (- $t7 _$t2))) (=> (= $t17 (- $t7 _$t2)) (=> (= (ControlFlow 0 9) (- 0 8)) (= $t18 (+ $t8 _$t2)))))))))))))))))))
(let ((L3_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) _$t1))) (< $t7 _$t2)) (> (+ $t8 _$t2) 18446744073709551615)) (= $t6 _$t1)))))
...
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon13_Else_correct|  (=> (and (and (and (not $abort_flag@9) (= |inline$$bc_BasicCoin_deposit'#0'$0$$t11@1| ($Mutation_21031 (|l#$Mutation_21031| call3formal@result@0) (|p#$Mutation_21031| call3formal@result@0) inline$$AddU64$0$dst@2 (|v_final#$Mutation_21031| call3formal@result@0)))) (and (= (|v#$Mutation_21031| |inline$$bc_BasicCoin_deposit'#0'$0$$t11@1|) (|v_final#$Mutation_21031| |inline$$bc_BasicCoin_deposit'#0'$0$$t11@1|)) (= (|v#$Mutation_57370| |inline$$bc_BasicCoin_deposit'#0'$0$$t10@1|) (|v_final#$Mutation_57370| |inline$$bc_BasicCoin_deposit'#0'$0$$t10@1|)))) (and (and (= (|v#$Mutation_57347| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@2|) (|v_final#$Mutation_57347| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@2|)) (= $abort_flag@10 $abort_flag@9)) (and (= $abort_code@8 $abort_code@7) (= |$bc_BasicCoin_Balance'#0'_$memory@7| |$bc_BasicCoin_Balance'#0'_$memory@5|)))) (and (=> (= (ControlFlow 0 16) 7) anon16_Then_correct) (=> (= (ControlFlow 0 16) 9) anon16_Else_correct)))))
...
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon12_Else_correct|  (=> (not $abort_flag@8) (=> (and (and (= call2formal@v@0 (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_57347| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|))) (= (|v#$Mutation_57370| call3formal@result@0@@0) (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_57347| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|)))) (and (= |inline$$bc_BasicCoin_deposit'#0'$0$$t9@2| ($Mutation_57347 (|l#$Mutation_57347| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|) (|p#$Mutation_57347| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|) (|$bc_BasicCoin_Balance'#0'| (|v_final#$Mutation_57370| call3formal@result@0@@0)) (|v_final#$Mutation_57347| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|))) (= (|v#$Mutation_57347| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@2|) (|v_final#$Mutation_57347| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@2|)))) (=> (and (and (and (= call2formal@v@0@@0 (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_57370| call3formal@result@0@@0))) (= (|v#$Mutation_21031| call3formal@result@0) (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_57370| call3formal@result@0@@0)))) (and (= |inline$$bc_BasicCoin_deposit'#0'$0$$t10@1| ($Mutation_57370 (|l#$Mutation_57370| call3formal@result@0@@0) (|p#$Mutation_57370| call3formal@result@0@@0) (|$bc_BasicCoin_Coin'#0'| (|v_final#$Mutation_21031| call3formal@result@0)) (|v_final#$Mutation_57370| call3formal@result@0@@0))) (= (|v#$Mutation_57370| |inline$$bc_BasicCoin_deposit'#0'$0$$t10@1|) (|v_final#$Mutation_57370| |inline$$bc_BasicCoin_deposit'#0'$0$$t10@1|)))) (and (and (= |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1| (|$value#$bc_BasicCoin_Coin'#0'| |inline$$bc_BasicCoin_withdraw'#0'$0$$ret0@1|)) (= |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1| |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1|)) (and (= |inline$$bc_BasicCoin_deposit'#0'$0$$temp_0'u64'@1| (|v#$Mutation_21031| call3formal@result@0)) (= |inline$$bc_BasicCoin_deposit'#0'$0$$temp_0'u64'@1| |inline$$bc_BasicCoin_deposit'#0'$0$$temp_0'u64'@1|)))) (and (=> (= (ControlFlow 0 24) 23) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 24) 21) inline$$AddU64$0$anon3_Else_correct)))))))
...
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon11_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1)) (= (ControlFlow 0 27) 26)) |inline$$bc_BasicCoin_deposit'#0'$0$anon11_Then$1_correct|)))
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon11_Else_correct|  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1) (= call0formal@l@0 ($Global _$t1))) (=> (and (and (and (= call1formal@p@0 (Vec_11028 (MapConstVec_19835 DefaultVecElem_19835) 0)) (= call2formal@v@0@@1 (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1))) (and (= (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1) (|v#$Mutation_57347| call3formal@result@0@@1)) (= |$bc_BasicCoin_Balance'#0'_$memory@4| ($Memory_56677 (|Store__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1 true) (|Store__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1 (|v_final#$Mutation_57347| call3formal@result@0@@1)))))) (and (and (= |$bc_BasicCoin_Balance'#0'_$memory@5| |$bc_BasicCoin_Balance'#0'_$memory@4|) (= |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1| call3formal@result@0@@1)) (and (= $abort_code@6 $abort_code@5) (= $abort_flag@8 $abort_flag@7)))) (and (=> (= (ControlFlow 0 25) 19) |inline$$bc_BasicCoin_deposit'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 25) 24) |inline$$bc_BasicCoin_deposit'#0'$0$anon12_Else_correct|))))))
...
(let ((|inline$$bc_BasicCoin_balance_of'#0'$1$anon6_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1)) (= (ControlFlow 0 33) 32)) |inline$$bc_BasicCoin_balance_of'#0'$1$anon6_Then$1_correct|)))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$1$anon6_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1) (=> (and (and (= |inline$$bc_BasicCoin_balance_of'#0'$1$$t1@1| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1)) (= $abort_code@5 $abort_code@4)) (and (= $abort_flag@6 $abort_flag@5) (= |inline$$bc_BasicCoin_balance_of'#0'$1$$t1@2| |inline$$bc_BasicCoin_balance_of'#0'$1$$t1@1|))) (and (=> (= (ControlFlow 0 31) 29) |inline$$bc_BasicCoin_balance_of'#0'$1$anon7_Then_correct|) (=> (= (ControlFlow 0 31) 30) |inline$$bc_BasicCoin_balance_of'#0'$1$anon7_Else_correct|))))))
...
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon18_Else_correct|  (=> (not $abort_flag@3) (=> (and (and (and (= call2formal@v@0@@2 (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_57347| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1|))) (= (|v#$Mutation_57370| call3formal@result@0@@3) (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_57347| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1|)))) (and (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@2| ($Mutation_57347 (|l#$Mutation_57347| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1|) (|p#$Mutation_57347| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1|) (|$bc_BasicCoin_Balance'#0'| (|v_final#$Mutation_57370| call3formal@result@0@@3)) (|v_final#$Mutation_57347| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1|))) (= (|v#$Mutation_57347| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@2|) (|v_final#$Mutation_57347| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@2|)))) (and (and (= call2formal@v@0@@3 (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_57370| call3formal@result@0@@3))) (= (|v#$Mutation_21031| call3formal@result@0@@2) (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_57370| call3formal@result@0@@3)))) (and (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t10@1| ($Mutation_57370 (|l#$Mutation_57370| call3formal@result@0@@3) (|p#$Mutation_57370| call3formal@result@0@@3) (|$bc_BasicCoin_Coin'#0'| (|v_final#$Mutation_21031| call3formal@result@0@@2)) (|v_final#$Mutation_57370| call3formal@result@0@@3))) (= (|v#$Mutation_57370| |inline$$bc_BasicCoin_withdraw'#0'$0$$t10@1|) (|v_final#$Mutation_57370| |inline$$bc_BasicCoin_withdraw'#0'$0$$t10@1|))))) (and (=> (= (ControlFlow 0 46) 45) inline$$SubU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 46) 43) inline$$SubU64$0$anon3_Else_correct))))))
...
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon17_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1)) (= (ControlFlow 0 49) 48)) |inline$$bc_BasicCoin_withdraw'#0'$0$anon17_Then$1_correct|)))
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon17_Else_correct|  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1) (= call0formal@l@0@@0 ($Global inline$$1_signer_address_of$0$$ret0@1))) (=> (and (and (and (= call1formal@p@0@@0 (Vec_11028 (MapConstVec_19835 DefaultVecElem_19835) 0)) (= call2formal@v@0@@4 (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1))) (and (= (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1) (|v#$Mutation_57347| call3formal@result@0@@4)) (= |$bc_BasicCoin_Balance'#0'_$memory@0| ($Memory_56677 (|Store__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1 true) (|Store__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1 (|v_final#$Mutation_57347| call3formal@result@0@@4)))))) (and (and (= |$bc_BasicCoin_Balance'#0'_$memory@1| |$bc_BasicCoin_Balance'#0'_$memory@0|) (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1| call3formal@result@0@@4)) (and (= $abort_code@2 $abort_code@1) (= $abort_flag@3 $abort_flag@2)))) (and (=> (= (ControlFlow 0 47) 40) |inline$$bc_BasicCoin_withdraw'#0'$0$anon18_Then_correct|) (=> (= (ControlFlow 0 47) 46) |inline$$bc_BasicCoin_withdraw'#0'$0$anon18_Else_correct|))))))
...
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1)) (= (ControlFlow 0 57) 56)) |inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then$1_correct|)))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1) (=> (and (and (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@1| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1)) (= $abort_code@1 $abort_code@0)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@2| |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 55) 53) |inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Then_correct|) (=> (= (ControlFlow 0 55) 54) |inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Else_correct|))))))
...
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon0_correct|  (=> (and (and (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t5@0| (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1)))) (= inline$$1_signer_address_of$0$$ret0@1 inline$$1_signer_address_of$0$$ret0@1)) (and (= _$t2 _$t2) (= (ControlFlow 0 59) 58))) |inline$$bc_BasicCoin_balance_of'#0'$0$anon0_correct|)))
(let ((anon14_Then_correct  (=> $t11@0 (=> (and (= $t12 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1)))) (= (ControlFlow 0 60) 59)) |inline$$bc_BasicCoin_withdraw'#0'$0$anon0_correct|))))
...
)))) (and (and (and (= $t6 (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))) (= $t7 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) $t6))))) (and (= $t8 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_56677| |$bc_BasicCoin_Balance'#0'_$memory|) _$t1)))) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= _$t3 _$t3) (= (ControlFlow 0 65) 64))))) inline$$1_signer_address_of$0$anon0_correct)))
