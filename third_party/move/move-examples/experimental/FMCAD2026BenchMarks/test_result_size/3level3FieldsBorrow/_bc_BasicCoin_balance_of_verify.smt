...
(declare-fun $t1@1 () |T@$bc_BasicCoin_Balance'#0'|)
(declare-fun $t4@0 () Int)
(declare-fun |$bc_BasicCoin_Balance'#0'_$memory| () T@$Memory_57209)
(declare-fun _$t0 () Int)
(declare-fun $abort_code@1 () Int)
(declare-fun $t1 () |T@$bc_BasicCoin_Balance'#0'|)
(declare-fun $t1@0 () |T@$bc_BasicCoin_Balance'#0'|)
...
(set-info :boogie-vc-id $bc_BasicCoin_balance_of$verify)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((anon8_Else_correct  (=> (not $abort_flag@0) (=> (and (and (= $t3@0 (|$coin#$bc_BasicCoin_Balance'#0'| $t1@1)) (= $t4@0 (|$value#$bc_BasicCoin_Coin'#0'| $t3@0))) (and (= $t4@0 $t4@0) (= (ControlFlow 0 4) (- 0 3)))) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)))))))
(let ((anon8_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 2) (- 0 1))) (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0))))))
(let ((anon7_Then$1_correct  (=> (= $t1@1 $t1) (=> (and (= $abort_flag@0 true) (= $abort_code@1 $EXEC_FAILURE_CODE)) (and (=> (= (ControlFlow 0 6) 2) anon8_Then_correct) (=> (= (ControlFlow 0 6) 4) anon8_Else_correct))))))
(let ((anon7_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (= (ControlFlow 0 7) 6)) anon7_Then$1_correct)))
(let ((anon7_Else_correct  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0) (=> (and (and (= $t1@0 (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (= $t1@1 $t1@0)) (and (= $abort_flag@0 false) (= $abort_code@1 $abort_code@0))) (and (=> (= (ControlFlow 0 5) 2) anon8_Then_correct) (=> (= (ControlFlow 0 5) 4) anon8_Else_correct))))))
(let ((anon0$1_correct  (=> (|$IsValid'address'| _$t0) (=> (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) $a_0)))
(|$IsValid'$bc_BasicCoin_Balance'#0''| $rsc))
 :qid |outputbpl.4673:20|
 :skolemid |173|
 :pattern ( (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) $a_0))
)) (= _$t0 _$t0)) (and (=> (= (ControlFlow 0 8) 7) anon7_Then_correct) (=> (= (ControlFlow 0 8) 5) anon7_Else_correct))))))
(let ((inline$$InitVerification$0$anon3_Else_correct  (=> (and $cur_index_initialized (= (ControlFlow 0 10) 8)) anon0$1_correct)))
(let ((inline$$InitVerification$0$anon3_Then_correct  (=> (and (not $cur_index_initialized) (= (ControlFlow 0 9) 8)) anon0$1_correct)))
(let ((anon0_correct  (and (=> (= (ControlFlow 0 11) 9) inline$$InitVerification$0$anon3_Then_correct) (=> (= (ControlFlow 0 11) 10) inline$$InitVerification$0$anon3_Else_correct))))
anon0_correct))))))))))
))
(check-sat)
(get-info :rlimit)
