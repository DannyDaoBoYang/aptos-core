...
(declare-fun |$bc_BasicCoin_Balance'#0'_$memory@7| () T@$Memory_57209)
(declare-fun $t6 () Int)
(declare-fun $t18 () Int)
(declare-fun _$t1 () Int)
(declare-fun |$bc_BasicCoin_Balance'#0'_$memory| () T@$Memory_57209)
(declare-fun $t7 () Int)
(declare-fun _$t2 () Int)
(declare-fun $t8 () Int)
(declare-fun $abort_code@8 () Int)
(declare-fun |inline$$bc_BasicCoin_deposit'#0'$0$$t8@1| () Int)
(declare-fun |$bc_BasicCoin_Balance'#0'_$memory@6| () T@$Memory_57209)
(declare-fun $abort_flag@9 () Bool)
(declare-fun $abort_code@7 () Int)
(declare-fun |$bc_BasicCoin_Balance'#0'_$memory@5| () T@$Memory_57209)
(declare-fun $abort_flag@8 () Bool)
(declare-fun $abort_code@6 () Int)
(declare-fun $abort_flag@7 () Bool)
(declare-fun $abort_code@5 () Int)
(declare-fun |$bc_BasicCoin_Balance'#0'_$memory@3| () T@$Memory_57209)
...
(declare-fun |inline$$bc_BasicCoin_deposit'#0'$0$$t10@1| () T@$Mutation_57902)
(declare-fun |inline$$bc_BasicCoin_deposit'#0'$0$$t9@2| () T@$Mutation_57879)
(declare-fun inline$$AddU64$0$dst@0 () Int)
(declare-fun |inline$$bc_BasicCoin_balance_of'#0'$1$$ret0@1| () Int)
(declare-fun |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1| () Int)
(declare-fun inline$$AddU64$0$dst@1 () Int)
(declare-fun call2formal@v@0 () |T@$bc_BasicCoin_Coin'#0'|)
(declare-fun |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1| () T@$Mutation_57879)
(declare-fun call3formal@result@0@@0 () T@$Mutation_57902)
(declare-fun call2formal@v@0@@0 () Int)
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$ret0@1| () |T@$bc_BasicCoin_Coin'#0'|)
(declare-fun |inline$$bc_BasicCoin_deposit'#0'$0$$temp_0'u64'@1| () Int)
(declare-fun |inline$$bc_BasicCoin_deposit'#0'$0$$t9@0| () T@$Mutation_57879)
...
(declare-fun call3formal@result@0@@1 () T@$Mutation_57879)
(declare-fun |$bc_BasicCoin_Balance'#0'_$memory@4| () T@$Memory_57209)
...
(declare-fun |inline$$bc_BasicCoin_balance_of'#0'$1$$t3@1| () |T@$bc_BasicCoin_Coin'#0'|)
(declare-fun |inline$$bc_BasicCoin_balance_of'#0'$1$$t1@2| () |T@$bc_BasicCoin_Balance'#0'|)
(declare-fun |inline$$bc_BasicCoin_balance_of'#0'$1$$t4@1| () Int)
(declare-fun |inline$$bc_BasicCoin_balance_of'#0'$1$$ret0@0| () Int)
(declare-fun |inline$$bc_BasicCoin_balance_of'#0'$1$$t1@0| () |T@$bc_BasicCoin_Balance'#0'|)
(declare-fun |inline$$bc_BasicCoin_balance_of'#0'$1$$t1@1| () |T@$bc_BasicCoin_Balance'#0'|)
...
(declare-fun inline$$SubU64$0$dst@2 () Int)
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$temp_0'u64'@1| () Int)
(declare-fun call3formal@result@0@@2 () T@$Mutation_21031)
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$t11@1| () T@$Mutation_21031)
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$t10@1| () T@$Mutation_57902)
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@2| () T@$Mutation_57879)
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$t13@1| () |T@$bc_BasicCoin_Coin'#0'|)
(declare-fun |$bc_BasicCoin_Balance'#0'_$memory@1| () T@$Memory_57209)
(declare-fun $abort_code@3 () Int)
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$ret0@0| () |T@$bc_BasicCoin_Coin'#0'|)
(declare-fun |$bc_BasicCoin_Balance'#0'_$memory@2| () T@$Memory_57209)
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$t7@1| () Int)
(declare-fun inline$$SubU64$0$dst@0 () Int)
(declare-fun |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| () Int)
(declare-fun inline$$SubU64$0$dst@1 () Int)
(declare-fun $abort_code@2 () Int)
(declare-fun $abort_flag@3 () Bool)
(declare-fun call2formal@v@0@@2 () |T@$bc_BasicCoin_Coin'#0'|)
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1| () T@$Mutation_57879)
(declare-fun call3formal@result@0@@3 () T@$Mutation_57902)
(declare-fun call2formal@v@0@@3 () Int)
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@0| () T@$Mutation_57879)
(declare-fun inline$$1_signer_address_of$0$$ret0@1 () Int)
(declare-fun call0formal@l@0@@0 () T@$Location)
(declare-fun call1formal@p@0@@0 () T@Vec_11028)
(declare-fun call2formal@v@0@@4 () |T@$bc_BasicCoin_Balance'#0'|)
(declare-fun call3formal@result@0@@4 () T@$Mutation_57879)
(declare-fun |$bc_BasicCoin_Balance'#0'_$memory@0| () T@$Memory_57209)
...
(declare-fun |inline$$bc_BasicCoin_withdraw'#0'$0$$t5@0| () Int)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 68) (let ((anon16_Else_correct  (=> (not $abort_flag@10) (=> (and (= $t17 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@7|) $t6)))) (= $t18 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@7|) _$t1))))) (and (=> (= (ControlFlow 0 9) (- 0 15)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) $t6)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) $t6))) (and (=> (= (ControlFlow 0 9) (- 0 14)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t1)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t1))) (and (=> (= (ControlFlow 0 9) (- 0 13)) (not (< $t7 _$t2))) (=> (not (< $t7 _$t2)) (and (=> (= (ControlFlow 0 9) (- 0 12)) (not (> (+ $t8 _$t2) 18446744073709551615))) (=> (not (> (+ $t8 _$t2) 18446744073709551615)) (and (=> (= (ControlFlow 0 9) (- 0 11)) (not (= $t6 _$t1))) (=> (not (= $t6 _$t1)) (and (=> (= (ControlFlow 0 9) (- 0 10)) (= $t17 (- $t7 _$t2))) (=> (= $t17 (- $t7 _$t2)) (=> (= (ControlFlow 0 9) (- 0 8)) (= $t18 (+ $t8 _$t2)))))))))))))))))))
(let ((L3_correct  (=> (= (ControlFlow 0 3) (- 0 2)) (or (or (or (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) $t6)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t1))) (< $t7 _$t2)) (> (+ $t8 _$t2) 18446744073709551615)) (= $t6 _$t1)))))
(let ((anon16_Then_correct  (=> $abort_flag@10 (=> (and (= $abort_code@8 $abort_code@8) (= (ControlFlow 0 7) 3)) L3_correct))))
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$L2_correct|  (=> (= $abort_flag@10 true) (=> (and (= $abort_code@8 |inline$$bc_BasicCoin_deposit'#0'$0$$t8@1|) (= |$bc_BasicCoin_Balance'#0'_$memory@7| |$bc_BasicCoin_Balance'#0'_$memory@6|)) (and (=> (= (ControlFlow 0 17) 7) anon16_Then_correct) (=> (= (ControlFlow 0 17) 9) anon16_Else_correct))))))
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon13_Then_correct|  (=> $abort_flag@9 (=> (and (and (= $abort_code@7 $abort_code@7) (= |inline$$bc_BasicCoin_deposit'#0'$0$$t8@1| $abort_code@7)) (and (= |$bc_BasicCoin_Balance'#0'_$memory@6| |$bc_BasicCoin_Balance'#0'_$memory@5|) (= (ControlFlow 0 20) 17))) |inline$$bc_BasicCoin_deposit'#0'$0$L2_correct|))))
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon12_Then_correct|  (=> $abort_flag@8 (=> (and (and (= $abort_code@6 $abort_code@6) (= |inline$$bc_BasicCoin_deposit'#0'$0$$t8@1| $abort_code@6)) (and (= |$bc_BasicCoin_Balance'#0'_$memory@6| |$bc_BasicCoin_Balance'#0'_$memory@5|) (= (ControlFlow 0 19) 17))) |inline$$bc_BasicCoin_deposit'#0'$0$L2_correct|))))
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon10_Then_correct|  (=> $abort_flag@7 (=> (and (and (= $abort_code@5 $abort_code@5) (= |inline$$bc_BasicCoin_deposit'#0'$0$$t8@1| $abort_code@5)) (and (= |$bc_BasicCoin_Balance'#0'_$memory@6| |$bc_BasicCoin_Balance'#0'_$memory@3|) (= (ControlFlow 0 18) 17))) |inline$$bc_BasicCoin_deposit'#0'$0$L2_correct|))))
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon13_Else_correct|  (=> (and (and (and (not $abort_flag@9) (= |inline$$bc_BasicCoin_deposit'#0'$0$$t11@1| ($Mutation_21031 (|l#$Mutation_21031| call3formal@result@0) (|p#$Mutation_21031| call3formal@result@0) inline$$AddU64$0$dst@2 (|v_final#$Mutation_21031| call3formal@result@0)))) (and (= (|v#$Mutation_21031| |inline$$bc_BasicCoin_deposit'#0'$0$$t11@1|) (|v_final#$Mutation_21031| |inline$$bc_BasicCoin_deposit'#0'$0$$t11@1|)) (= (|v#$Mutation_57902| |inline$$bc_BasicCoin_deposit'#0'$0$$t10@1|) (|v_final#$Mutation_57902| |inline$$bc_BasicCoin_deposit'#0'$0$$t10@1|)))) (and (and (= (|v#$Mutation_57879| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@2|) (|v_final#$Mutation_57879| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@2|)) (= $abort_flag@10 $abort_flag@9)) (and (= $abort_code@8 $abort_code@7) (= |$bc_BasicCoin_Balance'#0'_$memory@7| |$bc_BasicCoin_Balance'#0'_$memory@5|)))) (and (=> (= (ControlFlow 0 16) 7) anon16_Then_correct) (=> (= (ControlFlow 0 16) 9) anon16_Else_correct)))))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_flag@9 true) (=> (and (= $abort_code@7 $EXEC_FAILURE_CODE) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 22) 20) |inline$$bc_BasicCoin_deposit'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 22) 16) |inline$$bc_BasicCoin_deposit'#0'$0$anon13_Else_correct|))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (or (> (+ |inline$$bc_BasicCoin_balance_of'#0'$1$$ret0@1| |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1|) $MAX_U64) (< (+ |inline$$bc_BasicCoin_balance_of'#0'$1$$ret0@1| |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1|) $MIN_U64)) (= (ControlFlow 0 23) 22)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (not (or (> (+ |inline$$bc_BasicCoin_balance_of'#0'$1$$ret0@1| |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1|) $MAX_U64) (< (+ |inline$$bc_BasicCoin_balance_of'#0'$1$$ret0@1| |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1|) $MIN_U64))) (=> (and (and (= inline$$AddU64$0$dst@1 (+ |inline$$bc_BasicCoin_balance_of'#0'$1$$ret0@1| |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1|)) (= $abort_flag@9 $abort_flag@8)) (and (= $abort_code@7 $abort_code@6) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 21) 20) |inline$$bc_BasicCoin_deposit'#0'$0$anon13_Then_correct|) (=> (= (ControlFlow 0 21) 16) |inline$$bc_BasicCoin_deposit'#0'$0$anon13_Else_correct|))))))
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon12_Else_correct|  (=> (not $abort_flag@8) (=> (and (and (= call2formal@v@0 (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_57879| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|))) (= (|v#$Mutation_57902| call3formal@result@0@@0) (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_57879| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|)))) (and (= |inline$$bc_BasicCoin_deposit'#0'$0$$t9@2| ($Mutation_57879 (|l#$Mutation_57879| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|) (|p#$Mutation_57879| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|) (|$bc_BasicCoin_Balance'#0'| (|v_final#$Mutation_57902| call3formal@result@0@@0)) (|v_final#$Mutation_57879| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1|))) (= (|v#$Mutation_57879| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@2|) (|v_final#$Mutation_57879| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@2|)))) (=> (and (and (and (= call2formal@v@0@@0 (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_57902| call3formal@result@0@@0))) (= (|v#$Mutation_21031| call3formal@result@0) (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_57902| call3formal@result@0@@0)))) (and (= |inline$$bc_BasicCoin_deposit'#0'$0$$t10@1| ($Mutation_57902 (|l#$Mutation_57902| call3formal@result@0@@0) (|p#$Mutation_57902| call3formal@result@0@@0) (|$bc_BasicCoin_Coin'#0'| (|v_final#$Mutation_21031| call3formal@result@0)) (|v_final#$Mutation_57902| call3formal@result@0@@0))) (= (|v#$Mutation_57902| |inline$$bc_BasicCoin_deposit'#0'$0$$t10@1|) (|v_final#$Mutation_57902| |inline$$bc_BasicCoin_deposit'#0'$0$$t10@1|)))) (and (and (= |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1| (|$value#$bc_BasicCoin_Coin'#0'| |inline$$bc_BasicCoin_withdraw'#0'$0$$ret0@1|)) (= |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1| |inline$$bc_BasicCoin_deposit'#0'$0$$t12@1|)) (and (= |inline$$bc_BasicCoin_deposit'#0'$0$$temp_0'u64'@1| (|v#$Mutation_21031| call3formal@result@0)) (= |inline$$bc_BasicCoin_deposit'#0'$0$$temp_0'u64'@1| |inline$$bc_BasicCoin_deposit'#0'$0$$temp_0'u64'@1|)))) (and (=> (= (ControlFlow 0 24) 23) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 24) 21) inline$$AddU64$0$anon3_Else_correct)))))))
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon11_Then$1_correct|  (=> (and (and (= |$bc_BasicCoin_Balance'#0'_$memory@5| |$bc_BasicCoin_Balance'#0'_$memory@3|) (= |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1| |inline$$bc_BasicCoin_deposit'#0'$0$$t9@0|)) (and (= $abort_code@6 $EXEC_FAILURE_CODE) (= $abort_flag@8 true))) (and (=> (= (ControlFlow 0 26) 19) |inline$$bc_BasicCoin_deposit'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 26) 24) |inline$$bc_BasicCoin_deposit'#0'$0$anon12_Else_correct|)))))
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon11_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1)) (= (ControlFlow 0 27) 26)) |inline$$bc_BasicCoin_deposit'#0'$0$anon11_Then$1_correct|)))
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon11_Else_correct|  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1) (= call0formal@l@0 ($Global _$t1))) (=> (and (and (and (= call1formal@p@0 (Vec_11028 (MapConstVec_19835 DefaultVecElem_19835) 0)) (= call2formal@v@0@@1 (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1))) (and (= (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1) (|v#$Mutation_57879| call3formal@result@0@@1)) (= |$bc_BasicCoin_Balance'#0'_$memory@4| ($Memory_57209 (|Store__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1 true) (|Store__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1 (|v_final#$Mutation_57879| call3formal@result@0@@1)))))) (and (and (= |$bc_BasicCoin_Balance'#0'_$memory@5| |$bc_BasicCoin_Balance'#0'_$memory@4|) (= |inline$$bc_BasicCoin_deposit'#0'$0$$t9@1| call3formal@result@0@@1)) (and (= $abort_code@6 $abort_code@5) (= $abort_flag@8 $abort_flag@7)))) (and (=> (= (ControlFlow 0 25) 19) |inline$$bc_BasicCoin_deposit'#0'$0$anon12_Then_correct|) (=> (= (ControlFlow 0 25) 24) |inline$$bc_BasicCoin_deposit'#0'$0$anon12_Else_correct|))))))
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon10_Else_correct|  (=> (not $abort_flag@7) (and (=> (= (ControlFlow 0 28) 27) |inline$$bc_BasicCoin_deposit'#0'$0$anon11_Then_correct|) (=> (= (ControlFlow 0 28) 25) |inline$$bc_BasicCoin_deposit'#0'$0$anon11_Else_correct|)))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$1$anon7_Else_correct|  (=> (and (not $abort_flag@6) (= |inline$$bc_BasicCoin_balance_of'#0'$1$$t3@1| (|$coin#$bc_BasicCoin_Balance'#0'| |inline$$bc_BasicCoin_balance_of'#0'$1$$t1@2|))) (=> (and (and (= |inline$$bc_BasicCoin_balance_of'#0'$1$$t4@1| (|$value#$bc_BasicCoin_Coin'#0'| |inline$$bc_BasicCoin_balance_of'#0'$1$$t3@1|)) (= |inline$$bc_BasicCoin_balance_of'#0'$1$$t4@1| |inline$$bc_BasicCoin_balance_of'#0'$1$$t4@1|)) (and (= $abort_flag@7 $abort_flag@6) (= |inline$$bc_BasicCoin_balance_of'#0'$1$$ret0@1| |inline$$bc_BasicCoin_balance_of'#0'$1$$t4@1|))) (and (=> (= (ControlFlow 0 30) 18) |inline$$bc_BasicCoin_deposit'#0'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 30) 28) |inline$$bc_BasicCoin_deposit'#0'$0$anon10_Else_correct|))))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$1$anon7_Then_correct|  (=> (and (and $abort_flag@6 (= $abort_code@5 $abort_code@5)) (and (= $abort_flag@7 true) (= |inline$$bc_BasicCoin_balance_of'#0'$1$$ret0@1| |inline$$bc_BasicCoin_balance_of'#0'$1$$ret0@0|))) (and (=> (= (ControlFlow 0 29) 18) |inline$$bc_BasicCoin_deposit'#0'$0$anon10_Then_correct|) (=> (= (ControlFlow 0 29) 28) |inline$$bc_BasicCoin_deposit'#0'$0$anon10_Else_correct|)))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$1$anon6_Then$1_correct|  (=> (= $abort_code@5 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@6 true) (= |inline$$bc_BasicCoin_balance_of'#0'$1$$t1@2| |inline$$bc_BasicCoin_balance_of'#0'$1$$t1@0|)) (and (=> (= (ControlFlow 0 32) 29) |inline$$bc_BasicCoin_balance_of'#0'$1$anon7_Then_correct|) (=> (= (ControlFlow 0 32) 30) |inline$$bc_BasicCoin_balance_of'#0'$1$anon7_Else_correct|))))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$1$anon6_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1)) (= (ControlFlow 0 33) 32)) |inline$$bc_BasicCoin_balance_of'#0'$1$anon6_Then$1_correct|)))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$1$anon6_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1) (=> (and (and (= |inline$$bc_BasicCoin_balance_of'#0'$1$$t1@1| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1)) (= $abort_code@5 $abort_code@4)) (and (= $abort_flag@6 $abort_flag@5) (= |inline$$bc_BasicCoin_balance_of'#0'$1$$t1@2| |inline$$bc_BasicCoin_balance_of'#0'$1$$t1@1|))) (and (=> (= (ControlFlow 0 31) 29) |inline$$bc_BasicCoin_balance_of'#0'$1$anon7_Then_correct|) (=> (= (ControlFlow 0 31) 30) |inline$$bc_BasicCoin_balance_of'#0'$1$anon7_Else_correct|))))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$1$anon0_correct|  (=> (= _$t1 _$t1) (and (=> (= (ControlFlow 0 34) 33) |inline$$bc_BasicCoin_balance_of'#0'$1$anon6_Then_correct|) (=> (= (ControlFlow 0 34) 31) |inline$$bc_BasicCoin_balance_of'#0'$1$anon6_Else_correct|)))))
(let ((|inline$$bc_BasicCoin_deposit'#0'$0$anon0_correct|  (=> (= |inline$$bc_BasicCoin_deposit'#0'$0$$t5@0| (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1)))) (=> (and (and (= |inline$$bc_BasicCoin_deposit'#0'$0$$t6@0| (|$value#$bc_BasicCoin_Coin'#0'| |inline$$bc_BasicCoin_withdraw'#0'$0$$ret0@1|)) (= _$t1 _$t1)) (and (= |inline$$bc_BasicCoin_withdraw'#0'$0$$ret0@1| |inline$$bc_BasicCoin_withdraw'#0'$0$$ret0@1|) (= (ControlFlow 0 35) 34))) |inline$$bc_BasicCoin_balance_of'#0'$1$anon0_correct|))))
(let ((anon15_Else_correct  (=> (not $abort_flag@5) (=> (and (and (= |inline$$bc_BasicCoin_withdraw'#0'$0$$ret0@1| |inline$$bc_BasicCoin_withdraw'#0'$0$$ret0@1|) (= $t14 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@3|) _$t1))))) (and (= $t15 (|$value#$bc_BasicCoin_Coin'#0'| |inline$$bc_BasicCoin_withdraw'#0'$0$$ret0@1|)) (= (ControlFlow 0 36) 35))) |inline$$bc_BasicCoin_deposit'#0'$0$anon0_correct|))))
(let ((anon15_Then_correct  (=> $abort_flag@5 (=> (and (= $abort_code@4 $abort_code@4) (= (ControlFlow 0 6) 3)) L3_correct))))
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon19_Else_correct|  (=> (and (not $abort_flag@4) (= inline$$SubU64$0$dst@2 inline$$SubU64$0$dst@2)) (=> (and (and (= |inline$$bc_BasicCoin_withdraw'#0'$0$$temp_0'u64'@1| (|v#$Mutation_21031| call3formal@result@0@@2)) (= |inline$$bc_BasicCoin_withdraw'#0'$0$$temp_0'u64'@1| |inline$$bc_BasicCoin_withdraw'#0'$0$$temp_0'u64'@1|)) (and (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t11@1| ($Mutation_21031 (|l#$Mutation_21031| call3formal@result@0@@2) (|p#$Mutation_21031| call3formal@result@0@@2) inline$$SubU64$0$dst@2 (|v_final#$Mutation_21031| call3formal@result@0@@2))) (= (|v#$Mutation_21031| |inline$$bc_BasicCoin_withdraw'#0'$0$$t11@1|) (|v_final#$Mutation_21031| |inline$$bc_BasicCoin_withdraw'#0'$0$$t11@1|)))) (=> (and (and (and (= (|v#$Mutation_57902| |inline$$bc_BasicCoin_withdraw'#0'$0$$t10@1|) (|v_final#$Mutation_57902| |inline$$bc_BasicCoin_withdraw'#0'$0$$t10@1|)) (= (|v#$Mutation_57879| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@2|) (|v_final#$Mutation_57879| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@2|))) (and (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t13@1| (|$bc_BasicCoin_Coin'#0'| _$t2)) (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t13@1| |inline$$bc_BasicCoin_withdraw'#0'$0$$t13@1|))) (and (and (= |inline$$bc_BasicCoin_withdraw'#0'$0$$ret0@1| |inline$$bc_BasicCoin_withdraw'#0'$0$$t13@1|) (= |$bc_BasicCoin_Balance'#0'_$memory@3| |$bc_BasicCoin_Balance'#0'_$memory@1|)) (and (= $abort_flag@5 $abort_flag@4) (= $abort_code@4 $abort_code@3)))) (and (=> (= (ControlFlow 0 42) 6) anon15_Then_correct) (=> (= (ControlFlow 0 42) 36) anon15_Else_correct)))))))
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$L3_correct|  (=> (and (and (= |inline$$bc_BasicCoin_withdraw'#0'$0$$ret0@1| |inline$$bc_BasicCoin_withdraw'#0'$0$$ret0@0|) (= |$bc_BasicCoin_Balance'#0'_$memory@3| |$bc_BasicCoin_Balance'#0'_$memory@2|)) (and (= $abort_flag@5 true) (= $abort_code@4 |inline$$bc_BasicCoin_withdraw'#0'$0$$t7@1|))) (and (=> (= (ControlFlow 0 37) 6) anon15_Then_correct) (=> (= (ControlFlow 0 37) 36) anon15_Else_correct)))))
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon19_Then_correct|  (=> $abort_flag@4 (=> (and (and (= $abort_code@3 $abort_code@3) (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t7@1| $abort_code@3)) (and (= |$bc_BasicCoin_Balance'#0'_$memory@2| |$bc_BasicCoin_Balance'#0'_$memory@1|) (= (ControlFlow 0 41) 37))) |inline$$bc_BasicCoin_withdraw'#0'$0$L3_correct|))))
(let ((inline$$SubU64$0$anon3_Then$1_correct  (=> (= $abort_code@3 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@4 true) (= inline$$SubU64$0$dst@2 inline$$SubU64$0$dst@0)) (and (=> (= (ControlFlow 0 44) 41) |inline$$bc_BasicCoin_withdraw'#0'$0$anon19_Then_correct|) (=> (= (ControlFlow 0 44) 42) |inline$$bc_BasicCoin_withdraw'#0'$0$anon19_Else_correct|))))))
(let ((inline$$SubU64$0$anon3_Then_correct  (=> (and (or (> (- |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| _$t2) $MAX_U64) (< (- |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| _$t2) $MIN_U64)) (= (ControlFlow 0 45) 44)) inline$$SubU64$0$anon3_Then$1_correct)))
(let ((inline$$SubU64$0$anon3_Else_correct  (=> (not (or (> (- |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| _$t2) $MAX_U64) (< (- |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| _$t2) $MIN_U64))) (=> (and (and (= inline$$SubU64$0$dst@1 (- |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| _$t2)) (= $abort_code@3 $abort_code@2)) (and (= $abort_flag@4 $abort_flag@3) (= inline$$SubU64$0$dst@2 inline$$SubU64$0$dst@1))) (and (=> (= (ControlFlow 0 43) 41) |inline$$bc_BasicCoin_withdraw'#0'$0$anon19_Then_correct|) (=> (= (ControlFlow 0 43) 42) |inline$$bc_BasicCoin_withdraw'#0'$0$anon19_Else_correct|))))))
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon18_Else_correct|  (=> (not $abort_flag@3) (=> (and (and (and (= call2formal@v@0@@2 (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_57879| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1|))) (= (|v#$Mutation_57902| call3formal@result@0@@3) (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_57879| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1|)))) (and (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@2| ($Mutation_57879 (|l#$Mutation_57879| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1|) (|p#$Mutation_57879| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1|) (|$bc_BasicCoin_Balance'#0'| (|v_final#$Mutation_57902| call3formal@result@0@@3)) (|v_final#$Mutation_57879| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1|))) (= (|v#$Mutation_57879| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@2|) (|v_final#$Mutation_57879| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@2|)))) (and (and (= call2formal@v@0@@3 (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_57902| call3formal@result@0@@3))) (= (|v#$Mutation_21031| call3formal@result@0@@2) (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_57902| call3formal@result@0@@3)))) (and (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t10@1| ($Mutation_57902 (|l#$Mutation_57902| call3formal@result@0@@3) (|p#$Mutation_57902| call3formal@result@0@@3) (|$bc_BasicCoin_Coin'#0'| (|v_final#$Mutation_21031| call3formal@result@0@@2)) (|v_final#$Mutation_57902| call3formal@result@0@@3))) (= (|v#$Mutation_57902| |inline$$bc_BasicCoin_withdraw'#0'$0$$t10@1|) (|v_final#$Mutation_57902| |inline$$bc_BasicCoin_withdraw'#0'$0$$t10@1|))))) (and (=> (= (ControlFlow 0 46) 45) inline$$SubU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 46) 43) inline$$SubU64$0$anon3_Else_correct))))))
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon18_Then_correct|  (=> $abort_flag@3 (=> (and (and (= $abort_code@2 $abort_code@2) (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t7@1| $abort_code@2)) (and (= |$bc_BasicCoin_Balance'#0'_$memory@2| |$bc_BasicCoin_Balance'#0'_$memory@1|) (= (ControlFlow 0 40) 37))) |inline$$bc_BasicCoin_withdraw'#0'$0$L3_correct|))))
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon17_Then$1_correct|  (=> (and (and (= |$bc_BasicCoin_Balance'#0'_$memory@1| |$bc_BasicCoin_Balance'#0'_$memory|) (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1| |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@0|)) (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= $abort_flag@3 true))) (and (=> (= (ControlFlow 0 48) 40) |inline$$bc_BasicCoin_withdraw'#0'$0$anon18_Then_correct|) (=> (= (ControlFlow 0 48) 46) |inline$$bc_BasicCoin_withdraw'#0'$0$anon18_Else_correct|)))))
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon17_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1)) (= (ControlFlow 0 49) 48)) |inline$$bc_BasicCoin_withdraw'#0'$0$anon17_Then$1_correct|)))
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon17_Else_correct|  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1) (= call0formal@l@0@@0 ($Global inline$$1_signer_address_of$0$$ret0@1))) (=> (and (and (and (= call1formal@p@0@@0 (Vec_11028 (MapConstVec_19835 DefaultVecElem_19835) 0)) (= call2formal@v@0@@4 (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1))) (and (= (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1) (|v#$Mutation_57879| call3formal@result@0@@4)) (= |$bc_BasicCoin_Balance'#0'_$memory@0| ($Memory_57209 (|Store__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1 true) (|Store__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1 (|v_final#$Mutation_57879| call3formal@result@0@@4)))))) (and (and (= |$bc_BasicCoin_Balance'#0'_$memory@1| |$bc_BasicCoin_Balance'#0'_$memory@0|) (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t9@1| call3formal@result@0@@4)) (and (= $abort_code@2 $abort_code@1) (= $abort_flag@3 $abort_flag@2)))) (and (=> (= (ControlFlow 0 47) 40) |inline$$bc_BasicCoin_withdraw'#0'$0$anon18_Then_correct|) (=> (= (ControlFlow 0 47) 46) |inline$$bc_BasicCoin_withdraw'#0'$0$anon18_Else_correct|))))))
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon16_Then_correct|  (=> inline$$Ge$0$dst@1 (and (=> (= (ControlFlow 0 50) 49) |inline$$bc_BasicCoin_withdraw'#0'$0$anon17_Then_correct|) (=> (= (ControlFlow 0 50) 47) |inline$$bc_BasicCoin_withdraw'#0'$0$anon17_Else_correct|)))))
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon16_Else_correct|  (=> (and (not inline$$Ge$0$dst@1) (|$IsValid'u64'| 1)) (=> (and (and (= 1 1) (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t7@1| 1)) (and (= |$bc_BasicCoin_Balance'#0'_$memory@2| |$bc_BasicCoin_Balance'#0'_$memory|) (= (ControlFlow 0 39) 37))) |inline$$bc_BasicCoin_withdraw'#0'$0$L3_correct|))))
(let ((inline$$Ge$0$anon0_correct  (=> (= inline$$Ge$0$dst@1 (>= |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| _$t2)) (and (=> (= (ControlFlow 0 51) 50) |inline$$bc_BasicCoin_withdraw'#0'$0$anon16_Then_correct|) (=> (= (ControlFlow 0 51) 39) |inline$$bc_BasicCoin_withdraw'#0'$0$anon16_Else_correct|)))))
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon15_Else_correct|  (=> (not $abort_flag@2) (=> (and (= |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1|) (= (ControlFlow 0 52) 51)) inline$$Ge$0$anon0_correct))))
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon15_Then_correct|  (=> $abort_flag@2 (=> (and (and (= $abort_code@1 $abort_code@1) (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t7@1| $abort_code@1)) (and (= |$bc_BasicCoin_Balance'#0'_$memory@2| |$bc_BasicCoin_Balance'#0'_$memory|) (= (ControlFlow 0 38) 37))) |inline$$bc_BasicCoin_withdraw'#0'$0$L3_correct|))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Else_correct|  (=> (and (not $abort_flag@1) (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t3@1| (|$coin#$bc_BasicCoin_Balance'#0'| |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@2|))) (=> (and (and (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t4@1| (|$value#$bc_BasicCoin_Coin'#0'| |inline$$bc_BasicCoin_balance_of'#0'$0$$t3@1|)) (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t4@1| |inline$$bc_BasicCoin_balance_of'#0'$0$$t4@1|)) (and (= $abort_flag@2 $abort_flag@1) (= |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| |inline$$bc_BasicCoin_balance_of'#0'$0$$t4@1|))) (and (=> (= (ControlFlow 0 54) 38) |inline$$bc_BasicCoin_withdraw'#0'$0$anon15_Then_correct|) (=> (= (ControlFlow 0 54) 52) |inline$$bc_BasicCoin_withdraw'#0'$0$anon15_Else_correct|))))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Then_correct|  (=> (and (and $abort_flag@1 (= $abort_code@1 $abort_code@1)) (and (= $abort_flag@2 true) (= |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 53) 38) |inline$$bc_BasicCoin_withdraw'#0'$0$anon15_Then_correct|) (=> (= (ControlFlow 0 53) 52) |inline$$bc_BasicCoin_withdraw'#0'$0$anon15_Else_correct|)))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then$1_correct|  (=> (= $abort_code@1 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@1 true) (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@2| |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@0|)) (and (=> (= (ControlFlow 0 56) 53) |inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Then_correct|) (=> (= (ControlFlow 0 56) 54) |inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Else_correct|))))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1)) (= (ControlFlow 0 57) 56)) |inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then$1_correct|)))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1) (=> (and (and (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@1| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1)) (= $abort_code@1 $abort_code@0)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@2| |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 55) 53) |inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Then_correct|) (=> (= (ControlFlow 0 55) 54) |inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Else_correct|))))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon0_correct|  (=> (= inline$$1_signer_address_of$0$$ret0@1 inline$$1_signer_address_of$0$$ret0@1) (and (=> (= (ControlFlow 0 58) 57) |inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then_correct|) (=> (= (ControlFlow 0 58) 55) |inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Else_correct|)))))
(let ((|inline$$bc_BasicCoin_withdraw'#0'$0$anon0_correct|  (=> (and (and (= |inline$$bc_BasicCoin_withdraw'#0'$0$$t5@0| (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1)))) (= inline$$1_signer_address_of$0$$ret0@1 inline$$1_signer_address_of$0$$ret0@1)) (and (= _$t2 _$t2) (= (ControlFlow 0 59) 58))) |inline$$bc_BasicCoin_balance_of'#0'$0$anon0_correct|)))
(let ((anon14_Then_correct  (=> $t11@0 (=> (and (= $t12 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1)))) (= (ControlFlow 0 60) 59)) |inline$$bc_BasicCoin_withdraw'#0'$0$anon0_correct|))))
(let ((anon14_Else_correct  (=> (and (and (not $t11@0) (|$IsValid'u64'| 4)) (and (= 4 4) (= (ControlFlow 0 5) 3))) L3_correct)))
(let ((anon13_Else_correct  (=> (not $abort_flag@0) (=> (and (= inline$$1_signer_address_of$0$$ret0@1 inline$$1_signer_address_of$0$$ret0@1) (= $t11@0  (not (= inline$$1_signer_address_of$0$$ret0@1 _$t1)))) (and (=> (= (ControlFlow 0 61) 60) anon14_Then_correct) (=> (= (ControlFlow 0 61) 5) anon14_Else_correct))))))
(let ((anon13_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@0 $abort_code@0) (= (ControlFlow 0 4) 3)) L3_correct))))
(let ((inline$$1_signer_address_of$0$anon3_Else_correct  (=> (and (and (not false) (= inline$$1_signer_borrow_address$0$res@1 inline$$1_signer_borrow_address$0$res@1)) (and (= $abort_flag@0 false) (= inline$$1_signer_address_of$0$$ret0@1 inline$$1_signer_borrow_address$0$res@1))) (and (=> (= (ControlFlow 0 62) 4) anon13_Then_correct) (=> (= (ControlFlow 0 62) 61) anon13_Else_correct)))))
(let ((inline$$1_signer_address_of$0$anon3_Then_correct true))
(let ((inline$$1_signer_borrow_address$0$anon0_correct  (=> (= inline$$1_signer_borrow_address$0$res@1 (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))) (and (=> (= (ControlFlow 0 63) 1) inline$$1_signer_address_of$0$anon3_Then_correct) (=> (= (ControlFlow 0 63) 62) inline$$1_signer_address_of$0$anon3_Else_correct)))))
(let ((inline$$1_signer_address_of$0$anon0_correct  (=> (and (= _$t0 _$t0) (= (ControlFlow 0 64) 63)) inline$$1_signer_borrow_address$0$anon0_correct)))
(let ((anon0$1_correct  (=> (and (and (and (and (and (ite (is-$signer _$t0) (|$IsValid'address'| (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0)))  (and (|$IsValid'address'| (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))) (|$IsValid'address'| (|$permission_addr#$permissioned_signer| _$t0)))) ($1_signer_is_txn_signer _$t0)) ($1_signer_is_txn_signer_addr (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0)))) (|$IsValid'address'| _$t1)) (and (|$IsValid'u64'| _$t2) (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) $a_0)))
(|$IsValid'$bc_BasicCoin_Balance'#0''| $rsc))
 :qid |outputbpl.5465:20|
 :skolemid |178|
 :pattern ( (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) $a_0))
)))) (and (and (and (= $t6 (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))) (= $t7 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) $t6))))) (and (= $t8 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t1)))) (= _$t0 _$t0))) (and (and (= _$t1 _$t1) (= _$t2 _$t2)) (and (= _$t3 _$t3) (= (ControlFlow 0 65) 64))))) inline$$1_signer_address_of$0$anon0_correct)))
(let ((inline$$InitVerification$0$anon3_Else_correct  (=> $cur_index_initialized (=> (and (= $cur_index@0 $cur_index) (= (ControlFlow 0 67) 65)) anon0$1_correct))))
(let ((inline$$InitVerification$0$anon3_Then_correct  (=> (not $cur_index_initialized) (=> (and (= $cur_index@0 0) (= (ControlFlow 0 66) 65)) anon0$1_correct))))
(let ((anon0_correct  (and (=> (= (ControlFlow 0 68) 66) inline$$InitVerification$0$anon3_Then_correct) (=> (= (ControlFlow 0 68) 67) inline$$InitVerification$0$anon3_Else_correct))))
anon0_correct)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
))
(check-sat)
(get-info :rlimit)
