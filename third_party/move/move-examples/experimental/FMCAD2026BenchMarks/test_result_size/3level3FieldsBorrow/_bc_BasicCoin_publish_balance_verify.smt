...
(declare-fun inline$$1_error_already_exists$0$$ret0@1 () Int)
(declare-fun $abort_code@4 () Int)
(declare-fun $abort_flag@4 () Bool)
(declare-fun inline$$1_error_canonical$0$$ret0@1 () Int)
(declare-fun inline$$1_error_already_exists$0$$ret0@0 () Int)
(declare-fun inline$$1_error_canonical$0$$t4@1 () Int)
(declare-fun inline$$1_error_canonical$0$$ret0@0 () Int)
...
(declare-fun inline$$ShlU64$0$dst@2 () Int)
(declare-fun inline$$AddU64$0$dst@1 () Int)
(declare-fun inline$$ShlU64$0$dst@0 () Int)
(declare-fun inline$$ShlU64$0$dst@1 () Int)
...
(declare-fun $t7@0 () |T@$bc_BasicCoin_Balance'#0'|)
(declare-fun $t3@0 () |T@$bc_BasicCoin_Coin'#0'|)
...
(set-info :boogie-vc-id $bc_BasicCoin_publish_balance$verify)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 40) (let ((L3_correct  (=> (= (ControlFlow 0 7) (- 0 6)) (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))))))
(let ((anon20_Else_correct  (=> (not $abort_flag@5) (=> (and (= inline$$1_error_already_exists$0$$ret0@1 inline$$1_error_already_exists$0$$ret0@1) (= (ControlFlow 0 15) 7)) L3_correct))))
(let ((anon20_Then_correct  (=> $abort_flag@5 (=> (and (= $abort_code@4 $abort_code@4) (= (ControlFlow 0 14) 7)) L3_correct))))
(let ((inline$$1_error_already_exists$0$anon3_Else_correct  (=> (and (and (not $abort_flag@4) (= inline$$1_error_canonical$0$$ret0@1 inline$$1_error_canonical$0$$ret0@1)) (and (= inline$$1_error_already_exists$0$$ret0@1 inline$$1_error_canonical$0$$ret0@1) (= $abort_flag@5 $abort_flag@4))) (and (=> (= (ControlFlow 0 17) 14) anon20_Then_correct) (=> (= (ControlFlow 0 17) 15) anon20_Else_correct)))))
(let ((inline$$1_error_already_exists$0$anon3_Then_correct  (=> (and (and $abort_flag@4 (= $abort_code@4 $abort_code@4)) (and (= inline$$1_error_already_exists$0$$ret0@1 inline$$1_error_already_exists$0$$ret0@0) (= $abort_flag@5 true))) (and (=> (= (ControlFlow 0 16) 14) anon20_Then_correct) (=> (= (ControlFlow 0 16) 15) anon20_Else_correct)))))
(let ((inline$$1_error_canonical$0$L2_correct  (=> (= $abort_flag@4 true) (=> (and (= $abort_code@4 inline$$1_error_canonical$0$$t4@1) (= inline$$1_error_canonical$0$$ret0@1 inline$$1_error_canonical$0$$ret0@0)) (and (=> (= (ControlFlow 0 19) 16) inline$$1_error_already_exists$0$anon3_Then_correct) (=> (= (ControlFlow 0 19) 17) inline$$1_error_already_exists$0$anon3_Else_correct))))))
(let ((inline$$1_error_canonical$0$anon6_Then_correct  (=> (and (and $abort_flag@3 (= $abort_code@3 $abort_code@3)) (and (= inline$$1_error_canonical$0$$t4@1 $abort_code@3) (= (ControlFlow 0 21) 19))) inline$$1_error_canonical$0$L2_correct)))
(let ((inline$$1_error_canonical$0$anon5_Then_correct  (=> (and (and $abort_flag@2 (= $abort_code@2 $abort_code@2)) (and (= inline$$1_error_canonical$0$$t4@1 $abort_code@2) (= (ControlFlow 0 20) 19))) inline$$1_error_canonical$0$L2_correct)))
(let ((inline$$1_error_canonical$0$anon6_Else_correct  (=> (not $abort_flag@3) (=> (and (and (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@2) (= $abort_flag@4 $abort_flag@3)) (and (= $abort_code@4 $abort_code@3) (= inline$$1_error_canonical$0$$ret0@1 inline$$AddU64$0$dst@2))) (and (=> (= (ControlFlow 0 18) 16) inline$$1_error_already_exists$0$anon3_Then_correct) (=> (= (ControlFlow 0 18) 17) inline$$1_error_already_exists$0$anon3_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_flag@3 true) (=> (and (= $abort_code@3 $EXEC_FAILURE_CODE) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 23) 21) inline$$1_error_canonical$0$anon6_Then_correct) (=> (= (ControlFlow 0 23) 18) inline$$1_error_canonical$0$anon6_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (or (> (+ inline$$ShlU64$0$dst@2 2) $MAX_U64) (< (+ inline$$ShlU64$0$dst@2 2) $MIN_U64)) (= (ControlFlow 0 24) 23)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (not (or (> (+ inline$$ShlU64$0$dst@2 2) $MAX_U64) (< (+ inline$$ShlU64$0$dst@2 2) $MIN_U64))) (=> (and (and (= inline$$AddU64$0$dst@1 (+ inline$$ShlU64$0$dst@2 2)) (= $abort_flag@3 $abort_flag@2)) (and (= $abort_code@3 $abort_code@2) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 22) 21) inline$$1_error_canonical$0$anon6_Then_correct) (=> (= (ControlFlow 0 22) 18) inline$$1_error_canonical$0$anon6_Else_correct))))))
(let ((inline$$1_error_canonical$0$anon5_Else_correct  (=> (not $abort_flag@2) (and (=> (= (ControlFlow 0 25) 24) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 25) 22) inline$$AddU64$0$anon3_Else_correct)))))
(let ((inline$$ShlU64$0$anon3_Then$1_correct  (=> (= $abort_code@2 $EXEC_FAILURE_CODE) (=> (and (= $abort_flag@2 true) (= inline$$ShlU64$0$dst@2 inline$$ShlU64$0$dst@0)) (and (=> (= (ControlFlow 0 27) 20) inline$$1_error_canonical$0$anon5_Then_correct) (=> (= (ControlFlow 0 27) 25) inline$$1_error_canonical$0$anon5_Else_correct))))))
(let ((inline$$ShlU64$0$anon3_Then_correct  (=> (and (>= 16 64) (= (ControlFlow 0 28) 27)) inline$$ShlU64$0$anon3_Then$1_correct)))
(let ((inline$$ShlU64$0$anon3_Else_correct  (=> (> 64 16) (=> (and (and (= inline$$ShlU64$0$dst@1 ($shlU64 8 16)) (= $abort_code@2 $abort_code@0)) (and (= $abort_flag@2 $abort_flag@0) (= inline$$ShlU64$0$dst@2 inline$$ShlU64$0$dst@1))) (and (=> (= (ControlFlow 0 26) 20) inline$$1_error_canonical$0$anon5_Then_correct) (=> (= (ControlFlow 0 26) 25) inline$$1_error_canonical$0$anon5_Else_correct))))))
(let ((inline$$ShlU64$0$anon0_correct  (=> (and (>= 16 0) (< 16 256)) (and (=> (= (ControlFlow 0 29) 28) inline$$ShlU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 29) 26) inline$$ShlU64$0$anon3_Else_correct)))))
(let ((inline$$1_error_canonical$0$anon0_correct  (=> (and (and (= 8 8) (= 2 2)) (and (|$IsValid'u8'| 16) (= (ControlFlow 0 30) 29))) inline$$ShlU64$0$anon0_correct)))
(let ((inline$$1_error_already_exists$0$anon0_correct  (=> (= 2 2) (=> (and (|$IsValid'u64'| 8) (= (ControlFlow 0 31) 30)) inline$$1_error_canonical$0$anon0_correct))))
(let ((anon17_Then_correct  (=> $t6@0 (=> (and (|$IsValid'u64'| 2) (= (ControlFlow 0 32) 31)) inline$$1_error_already_exists$0$anon0_correct))))
(let ((anon19_Then_correct  (=> $abort_flag@1 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 9) 7)) L3_correct))))
(let ((anon16_Then_correct  (=> $abort_flag@0 (=> (and (= $abort_code@0 $abort_code@0) (= (ControlFlow 0 8) 7)) L3_correct))))
(let ((anon19_Else_correct  (=> (and (not $abort_flag@1) (= $t10 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@1|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))))))) (and (=> (= (ControlFlow 0 3) (- 0 5)) (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))))) (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0)))) (and (=> (= (ControlFlow 0 3) (- 0 4)) (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@1|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0)))) (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@1|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))) (=> (= (ControlFlow 0 3) (- 0 2)) (= $t10 0)))))))))
(let ((anon18_Then$1_correct  (=> (= |$bc_BasicCoin_Balance'#0'_$memory@1| |$bc_BasicCoin_Balance'#0'_$memory|) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= $abort_flag@1 true)) (and (=> (= (ControlFlow 0 11) 9) anon19_Then_correct) (=> (= (ControlFlow 0 11) 3) anon19_Else_correct))))))
(let ((anon18_Then_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))) (= (ControlFlow 0 12) 11)) anon18_Then$1_correct)))
(let ((anon18_Else_correct  (=> (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0)))) (=> (and (and (= |$bc_BasicCoin_Balance'#0'_$memory@0| ($Memory_57209 (|Store__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0)) true) (|Store__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0)) $t7@0))) (= |$bc_BasicCoin_Balance'#0'_$memory@1| |$bc_BasicCoin_Balance'#0'_$memory@0|)) (and (= $abort_code@1 $abort_code@0) (= $abort_flag@1 $abort_flag@0))) (and (=> (= (ControlFlow 0 10) 9) anon19_Then_correct) (=> (= (ControlFlow 0 10) 3) anon19_Else_correct))))))
(let ((anon17_Else_correct  (=> (and (not $t6@0) (= $t7@0 (|$bc_BasicCoin_Balance'#0'| $t3@0))) (and (=> (= (ControlFlow 0 13) 12) anon18_Then_correct) (=> (= (ControlFlow 0 13) 10) anon18_Else_correct)))))
(let ((anon16_Else_correct  (=> (and (not $abort_flag@0) (= $t6@0 (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) inline$$1_signer_address_of$0$$ret0@1))) (and (=> (= (ControlFlow 0 33) 32) anon17_Then_correct) (=> (= (ControlFlow 0 33) 13) anon17_Else_correct)))))
(let ((inline$$1_signer_address_of$0$anon3_Else_correct  (=> (and (and (not false) (= inline$$1_signer_borrow_address$0$res@1 inline$$1_signer_borrow_address$0$res@1)) (and (= $abort_flag@0 false) (= inline$$1_signer_address_of$0$$ret0@1 inline$$1_signer_borrow_address$0$res@1))) (and (=> (= (ControlFlow 0 34) 8) anon16_Then_correct) (=> (= (ControlFlow 0 34) 33) anon16_Else_correct)))))
(let ((inline$$1_signer_address_of$0$anon3_Then_correct true))
(let ((inline$$1_signer_borrow_address$0$anon0_correct  (=> (= inline$$1_signer_borrow_address$0$res@1 (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))) (and (=> (= (ControlFlow 0 35) 1) inline$$1_signer_address_of$0$anon3_Then_correct) (=> (= (ControlFlow 0 35) 34) inline$$1_signer_address_of$0$anon3_Else_correct)))))
(let ((inline$$1_signer_address_of$0$anon0_correct  (=> (and (= _$t0 _$t0) (= (ControlFlow 0 36) 35)) inline$$1_signer_borrow_address$0$anon0_correct)))
(let ((anon0$1_correct  (=> (and (and (and (and (ite (is-$signer _$t0) (|$IsValid'address'| (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0)))  (and (|$IsValid'address'| (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0))) (|$IsValid'address'| (|$permission_addr#$permissioned_signer| _$t0)))) ($1_signer_is_txn_signer _$t0)) ($1_signer_is_txn_signer_addr (ite (is-$permissioned_signer _$t0) (|$addr#$permissioned_signer| _$t0) (|$addr#$signer| _$t0)))) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) $a_0)))
(|$IsValid'$bc_BasicCoin_Balance'#0''| $rsc))
 :qid |outputbpl.5281:20|
 :skolemid |177|
 :pattern ( (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) $a_0))
)) (= _$t0 _$t0))) (and (and (|$IsValid'u64'| 0) (= $t3@0 (|$bc_BasicCoin_Coin'#0'| 0))) (and (= $t3@0 $t3@0) (= (ControlFlow 0 37) 36)))) inline$$1_signer_address_of$0$anon0_correct)))
(let ((inline$$InitVerification$0$anon3_Else_correct  (=> (and $cur_index_initialized (= (ControlFlow 0 39) 37)) anon0$1_correct)))
(let ((inline$$InitVerification$0$anon3_Then_correct  (=> (and (not $cur_index_initialized) (= (ControlFlow 0 38) 37)) anon0$1_correct)))
(let ((anon0_correct  (and (=> (= (ControlFlow 0 40) 38) inline$$InitVerification$0$anon3_Then_correct) (=> (= (ControlFlow 0 40) 39) inline$$InitVerification$0$anon3_Else_correct))))
anon0_correct)))))))))))))))))))))))))))))))))))))
))
(check-sat)
(get-info :rlimit)
