...
(declare-fun _$t1 () |T@$bc_BasicCoin_Coin'#0'|)
...
(set-info :boogie-vc-id $bc_BasicCoin_deposit$verify)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 27) (let ((L2_correct  (=> (= (ControlFlow 0 6) (- 0 5)) (or (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (> (+ $t5 $t6) 18446744073709551615)))))
(let ((anon14_Then_correct  (=> $abort_flag@3 (=> (and (= $abort_code@3 $abort_code@3) (= (ControlFlow 0 9) 6)) L2_correct))))
(let ((anon13_Then_correct  (=> $abort_flag@2 (=> (and (= $abort_code@2 $abort_code@2) (= (ControlFlow 0 8) 6)) L2_correct))))
(let ((anon11_Then_correct  (=> $abort_flag@1 (=> (and (= $abort_code@1 $abort_code@1) (= (ControlFlow 0 7) 6)) L2_correct))))
(let ((anon14_Else_correct  (=> (and (not $abort_flag@3) (= $t11@0 ($Mutation_21031 (|l#$Mutation_21031| call3formal@result@0) (|p#$Mutation_21031| call3formal@result@0) inline$$AddU64$0$dst@2 (|v_final#$Mutation_21031| call3formal@result@0)))) (=> (and (and (= (|v#$Mutation_21031| $t11@0) (|v_final#$Mutation_21031| $t11@0)) (= (|v#$Mutation_57902| $t10@0) (|v_final#$Mutation_57902| $t10@0))) (and (= (|v#$Mutation_57879| $t9@1) (|v_final#$Mutation_57879| $t9@1)) (= $t14 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory@1|) _$t0)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)))) (=> (not (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (> (+ $t5 $t6) 18446744073709551615))) (=> (not (> (+ $t5 $t6) 18446744073709551615)) (=> (= (ControlFlow 0 2) (- 0 1)) (= $t14 (+ $t5 $t6)))))))))))
(let ((inline$$AddU64$0$anon3_Then$1_correct  (=> (= $abort_flag@3 true) (=> (and (= $abort_code@3 $EXEC_FAILURE_CODE) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@0)) (and (=> (= (ControlFlow 0 11) 9) anon14_Then_correct) (=> (= (ControlFlow 0 11) 2) anon14_Else_correct))))))
(let ((inline$$AddU64$0$anon3_Then_correct  (=> (and (or (> (+ |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| $t12@0) $MAX_U64) (< (+ |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| $t12@0) $MIN_U64)) (= (ControlFlow 0 12) 11)) inline$$AddU64$0$anon3_Then$1_correct)))
(let ((inline$$AddU64$0$anon3_Else_correct  (=> (not (or (> (+ |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| $t12@0) $MAX_U64) (< (+ |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| $t12@0) $MIN_U64))) (=> (and (and (= inline$$AddU64$0$dst@1 (+ |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| $t12@0)) (= $abort_flag@3 $abort_flag@2)) (and (= $abort_code@3 $abort_code@2) (= inline$$AddU64$0$dst@2 inline$$AddU64$0$dst@1))) (and (=> (= (ControlFlow 0 10) 9) anon14_Then_correct) (=> (= (ControlFlow 0 10) 2) anon14_Else_correct))))))
(let ((anon13_Else_correct  (=> (not $abort_flag@2) (=> (and (and (= call2formal@v@0 (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_57879| $t9@0))) (= (|v#$Mutation_57902| call3formal@result@0@@0) (|$coin#$bc_BasicCoin_Balance'#0'| (|v#$Mutation_57879| $t9@0)))) (and (= $t9@1 ($Mutation_57879 (|l#$Mutation_57879| $t9@0) (|p#$Mutation_57879| $t9@0) (|$bc_BasicCoin_Balance'#0'| (|v_final#$Mutation_57902| call3formal@result@0@@0)) (|v_final#$Mutation_57879| $t9@0))) (= (|v#$Mutation_57879| $t9@1) (|v_final#$Mutation_57879| $t9@1)))) (=> (and (and (and (= call2formal@v@0@@0 (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_57902| call3formal@result@0@@0))) (= (|v#$Mutation_21031| call3formal@result@0) (|$value#$bc_BasicCoin_Coin'#0'| (|v#$Mutation_57902| call3formal@result@0@@0)))) (and (= $t10@0 ($Mutation_57902 (|l#$Mutation_57902| call3formal@result@0@@0) (|p#$Mutation_57902| call3formal@result@0@@0) (|$bc_BasicCoin_Coin'#0'| (|v_final#$Mutation_21031| call3formal@result@0)) (|v_final#$Mutation_57902| call3formal@result@0@@0))) (= (|v#$Mutation_57902| $t10@0) (|v_final#$Mutation_57902| $t10@0)))) (and (and (= $t12@0 (|$value#$bc_BasicCoin_Coin'#0'| _$t1)) (= $t12@0 $t12@0)) (and (= |$temp_0'u64'@0| (|v#$Mutation_21031| call3formal@result@0)) (= |$temp_0'u64'@0| |$temp_0'u64'@0|)))) (and (=> (= (ControlFlow 0 13) 12) inline$$AddU64$0$anon3_Then_correct) (=> (= (ControlFlow 0 13) 10) inline$$AddU64$0$anon3_Else_correct)))))))
(let ((anon12_Then$1_correct  (=> (and (and (= |$bc_BasicCoin_Balance'#0'_$memory@1| |$bc_BasicCoin_Balance'#0'_$memory|) (= $t9@0 $t9)) (and (= $abort_code@2 $EXEC_FAILURE_CODE) (= $abort_flag@2 true))) (and (=> (= (ControlFlow 0 15) 8) anon13_Then_correct) (=> (= (ControlFlow 0 15) 13) anon13_Else_correct)))))
(let ((anon12_Then_correct  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (= (ControlFlow 0 16) 15)) anon12_Then$1_correct)))
(let ((anon12_Else_correct  (=> (and (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0) (= call0formal@l@0 ($Global _$t0))) (=> (and (and (and (= call1formal@p@0 (Vec_11028 (MapConstVec_19835 DefaultVecElem_19835) 0)) (= call2formal@v@0@@1 (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0))) (and (= (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0) (|v#$Mutation_57879| call3formal@result@0@@1)) (= |$bc_BasicCoin_Balance'#0'_$memory@0| ($Memory_57209 (|Store__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0 true) (|Store__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0 (|v_final#$Mutation_57879| call3formal@result@0@@1)))))) (and (and (= |$bc_BasicCoin_Balance'#0'_$memory@1| |$bc_BasicCoin_Balance'#0'_$memory@0|) (= $t9@0 call3formal@result@0@@1)) (and (= $abort_code@2 $abort_code@1) (= $abort_flag@2 $abort_flag@1)))) (and (=> (= (ControlFlow 0 14) 8) anon13_Then_correct) (=> (= (ControlFlow 0 14) 13) anon13_Else_correct))))))
(let ((anon11_Else_correct  (=> (not $abort_flag@1) (and (=> (= (ControlFlow 0 17) 16) anon12_Then_correct) (=> (= (ControlFlow 0 17) 14) anon12_Else_correct)))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Else_correct|  (=> (and (not $abort_flag@0) (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t3@1| (|$coin#$bc_BasicCoin_Balance'#0'| |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@2|))) (=> (and (and (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t4@1| (|$value#$bc_BasicCoin_Coin'#0'| |inline$$bc_BasicCoin_balance_of'#0'$0$$t3@1|)) (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t4@1| |inline$$bc_BasicCoin_balance_of'#0'$0$$t4@1|)) (and (= $abort_flag@1 $abort_flag@0) (= |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| |inline$$bc_BasicCoin_balance_of'#0'$0$$t4@1|))) (and (=> (= (ControlFlow 0 19) 7) anon11_Then_correct) (=> (= (ControlFlow 0 19) 17) anon11_Else_correct))))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Then_correct|  (=> (and (and $abort_flag@0 (= $abort_code@1 $abort_code@1)) (and (= $abort_flag@1 true) (= |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@1| |inline$$bc_BasicCoin_balance_of'#0'$0$$ret0@0|))) (and (=> (= (ControlFlow 0 18) 7) anon11_Then_correct) (=> (= (ControlFlow 0 18) 17) anon11_Else_correct)))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then$1_correct|  (=> (= $abort_flag@0 true) (=> (and (= $abort_code@1 $EXEC_FAILURE_CODE) (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@2| |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@0|)) (and (=> (= (ControlFlow 0 21) 18) |inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Then_correct|) (=> (= (ControlFlow 0 21) 19) |inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Else_correct|))))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then_correct|  (=> (and (not (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (= (ControlFlow 0 22) 21)) |inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then$1_correct|)))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Else_correct|  (=> (|Select__T@[Int]Bool_| (|domain#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0) (=> (and (and (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@1| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)) (= $abort_flag@0 false)) (and (= $abort_code@1 $abort_code@0) (= |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@2| |inline$$bc_BasicCoin_balance_of'#0'$0$$t1@1|))) (and (=> (= (ControlFlow 0 20) 18) |inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Then_correct|) (=> (= (ControlFlow 0 20) 19) |inline$$bc_BasicCoin_balance_of'#0'$0$anon7_Else_correct|))))))
(let ((|inline$$bc_BasicCoin_balance_of'#0'$0$anon0_correct|  (=> (= _$t0 _$t0) (and (=> (= (ControlFlow 0 23) 22) |inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Then_correct|) (=> (= (ControlFlow 0 23) 20) |inline$$bc_BasicCoin_balance_of'#0'$0$anon6_Else_correct|)))))
(let ((anon0$1_correct  (=> (and (and (and (|$IsValid'address'| _$t0) (|$IsValid'$bc_BasicCoin_Coin'#0''| _$t1)) (and (forall (($a_0 Int) ) (! (let (($rsc (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) $a_0)))
(|$IsValid'$bc_BasicCoin_Balance'#0''| $rsc))
 :qid |outputbpl.4992:20|
 :skolemid |175|
 :pattern ( (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) $a_0))
)) (= $t5 (|$value#$bc_BasicCoin_Coin'#0'| (|$coin#$bc_BasicCoin_Balance'#0'| (|Select__T@[Int]$bc_BasicCoin_Balance'#0'_| (|contents#$Memory_57209| |$bc_BasicCoin_Balance'#0'_$memory|) _$t0)))))) (and (and (= $t6 (|$value#$bc_BasicCoin_Coin'#0'| _$t1)) (= _$t0 _$t0)) (and (= _$t1 _$t1) (= (ControlFlow 0 24) 23)))) |inline$$bc_BasicCoin_balance_of'#0'$0$anon0_correct|)))
(let ((inline$$InitVerification$0$anon3_Else_correct  (=> $cur_index_initialized (=> (and (= $cur_index@0 $cur_index) (= (ControlFlow 0 26) 24)) anon0$1_correct))))
(let ((inline$$InitVerification$0$anon3_Then_correct  (=> (not $cur_index_initialized) (=> (and (= $cur_index@0 0) (= (ControlFlow 0 25) 24)) anon0$1_correct))))
(let ((anon0_correct  (and (=> (= (ControlFlow 0 27) 25) inline$$InitVerification$0$anon3_Then_correct) (=> (= (ControlFlow 0 27) 26) inline$$InitVerification$0$anon3_Else_correct))))
anon0_correct))))))))))))))))))))))))
))
(check-sat)
(get-info :rlimit)
