...
(declare-fun inline$$42_bitset128_union$0$$t5@1 () T@$42_bitset128_BitSet128)
(declare-fun _$t0 () T@$42_bitset128_BitSet128)
(declare-fun inline$$42_bitset128_intersect$0$$t5@1 () T@$42_bitset128_BitSet128)
(declare-fun inline$$OrBv128$0$dst@1 () (_ BitVec 128))
(declare-fun inline$$42_bitset128_union$0$$t2@1 () (_ BitVec 128))
(declare-fun inline$$42_bitset128_union$0$$t3@1 () (_ BitVec 128))
(declare-fun inline$$AndBv128$0$dst@1 () (_ BitVec 128))
(declare-fun inline$$42_bitset128_intersect$0$$t2@1 () (_ BitVec 128))
(declare-fun inline$$42_bitset128_intersect$0$$t3@1 () (_ BitVec 128))
(declare-fun $cur_index_initialized () Bool)
(set-info :boogie-vc-id $42_bitset128_ident$verify)
...
(set-option :pp.bv_literals false)
(assert (not
 (=> (= (ControlFlow 0 0) 16) (let ((anon6_Else_correct  (=> (and (not false) (= inline$$42_bitset128_union$0$$t5@1 inline$$42_bitset128_union$0$$t5@1)) (and (=> (= (ControlFlow 0 4) (- 0 5)) (= _$t0 inline$$42_bitset128_intersect$0$$t5@1)) (=> (= _$t0 inline$$42_bitset128_intersect$0$$t5@1) (=> (= (ControlFlow 0 4) (- 0 3)) (= _$t0 inline$$42_bitset128_union$0$$t5@1)))))))
(let ((anon6_Then_correct true))
(let ((inline$$42_bitset128_union$0$anon0$1_correct  (=> (and (= inline$$42_bitset128_union$0$$t5@1 ($42_bitset128_BitSet128 inline$$OrBv128$0$dst@1)) (= inline$$42_bitset128_union$0$$t5@1 inline$$42_bitset128_union$0$$t5@1)) (and (=> (= (ControlFlow 0 6) 2) anon6_Then_correct) (=> (= (ControlFlow 0 6) 4) anon6_Else_correct)))))
(let ((inline$$OrBv128$0$anon0_correct  (=> (and (= inline$$OrBv128$0$dst@1 (bvor inline$$42_bitset128_union$0$$t2@1 inline$$42_bitset128_union$0$$t3@1)) (= (ControlFlow 0 7) 6)) inline$$42_bitset128_union$0$anon0$1_correct)))
(let ((inline$$42_bitset128_union$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (and (= _$t0 _$t0) (= inline$$42_bitset128_union$0$$t2@1 (|$s#$42_bitset128_BitSet128| _$t0))) (and (= inline$$42_bitset128_union$0$$t3@1 (|$s#$42_bitset128_BitSet128| _$t0)) (= (ControlFlow 0 8) 7))) inline$$OrBv128$0$anon0_correct))))
(let ((anon5_Else_correct  (=> (not false) (=> (and (= inline$$42_bitset128_intersect$0$$t5@1 inline$$42_bitset128_intersect$0$$t5@1) (= (ControlFlow 0 9) 8)) inline$$42_bitset128_union$0$anon0_correct))))
(let ((anon5_Then_correct true))
(let ((inline$$42_bitset128_intersect$0$anon0$1_correct  (=> (and (= inline$$42_bitset128_intersect$0$$t5@1 ($42_bitset128_BitSet128 inline$$AndBv128$0$dst@1)) (= inline$$42_bitset128_intersect$0$$t5@1 inline$$42_bitset128_intersect$0$$t5@1)) (and (=> (= (ControlFlow 0 10) 1) anon5_Then_correct) (=> (= (ControlFlow 0 10) 9) anon5_Else_correct)))))
(let ((inline$$AndBv128$0$anon0_correct  (=> (and (= inline$$AndBv128$0$dst@1 (bvand inline$$42_bitset128_intersect$0$$t2@1 inline$$42_bitset128_intersect$0$$t3@1)) (= (ControlFlow 0 11) 10)) inline$$42_bitset128_intersect$0$anon0$1_correct)))
(let ((inline$$42_bitset128_intersect$0$anon0_correct  (=> (= _$t0 _$t0) (=> (and (and (= _$t0 _$t0) (= inline$$42_bitset128_intersect$0$$t2@1 (|$s#$42_bitset128_BitSet128| _$t0))) (and (= inline$$42_bitset128_intersect$0$$t3@1 (|$s#$42_bitset128_BitSet128| _$t0)) (= (ControlFlow 0 12) 11))) inline$$AndBv128$0$anon0_correct))))
(let ((anon0$1_correct  (=> (|$IsValid'$42_bitset128_BitSet128'| _$t0) (=> (and (= _$t0 _$t0) (= (ControlFlow 0 13) 12)) inline$$42_bitset128_intersect$0$anon0_correct))))
(let ((inline$$InitVerification$0$anon3_Else_correct  (=> (and $cur_index_initialized (= (ControlFlow 0 15) 13)) anon0$1_correct)))
(let ((inline$$InitVerification$0$anon3_Then_correct  (=> (and (not $cur_index_initialized) (= (ControlFlow 0 14) 13)) anon0$1_correct)))
(let ((anon0_correct  (and (=> (= (ControlFlow 0 16) 14) inline$$InitVerification$0$anon3_Then_correct) (=> (= (ControlFlow 0 16) 15) inline$$InitVerification$0$anon3_Else_correct))))
anon0_correct)))))))))))))))
))
(check-sat)
